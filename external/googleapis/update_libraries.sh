...
declare -A -r LIBRARIES=(
  ...
  ["cloudsecuritycompliance"]="@googleapis//google/cloud/cloudsecuritycompliance/v1:cloudsecuritycompliance_cc_grpc"
  ...
  ["configdelivery"]="@googleapis//google/cloud/configdelivery/v1:configdelivery_cc_grpc"
