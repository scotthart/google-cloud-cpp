...
class MetadataDecoratorGenerator : public ClassGeneratorInterface {
 public:
  ...
  ~MetadataDecoratorGenerator() override = default;

  MetadataDecoratorGenerator(MetadataDecoratorGenerator const&) = delete;
  MetadataDecoratorGenerator& operator=(MetadataDecoratorGenerator const&) =
      delete;
...
#endif  // GOOGLE_CLOUD_CPP_GENERATOR_INTERNAL_METADATA_DECORATOR_GENERATOR_H
