...
Status StubRestGenerator::GenerateHeader() {
  ...
  HeaderLocalIncludes(
      {//          HasBidirStreamingMethod()
       ...
       //       "google/cloud/internal/streaming_write_rpc.h"
       //                                 : "",
       "google/cloud/internal/rest_client.h",
       "google/cloud/internal/rest_context.h", "google/cloud/status_or.h",
...
Status StubRestGenerator::GenerateCc() {
  ...
  for (auto const& method : methods()) {
    ...
    //  return
    //  absl::make_unique<::google::cloud::internal::StreamingWriteRpcImpl<
    //      $request_type$, $response_type$>>(
    ...
    //    std::unique_ptr<grpc::ClientContext> context) {
    //  return
    //  google::cloud::internal::MakeStreamingReadWriteRpc<$request_type$,
    //  $response_type$>(
    //      cq, std::move(context),
...
//   {"}\n"}
            ...
            //        return grpc_stub_->Async$method_name$(context, request,
            //        cq);
            //      },
            ...
            //    "    $request_type$ const& request) {\n"
            //    "  auto stream =
            //    grpc_stub_->$method_name$(client_context.get(), request);\n"
            //    "  return
            //    absl::make_unique<google::cloud::internal::StreamingReadRpcImpl<\n"
            //    "      $response_type$>>(\n"
  ...
  //    std::unique_ptr<grpc::ClientContext> context,
  //    $request_type$ const& request) {
  //  return google::cloud::internal::MakeStreamingReadRpc<$request_type$,
  //  $response_type$>(
  //    cq, std::move(context), request,
  //    [this](grpc::ClientContext* context, $request_type$ const& request,
  //    grpc::CompletionQueue* cq) {
  ...
  //    google::cloud::CompletionQueue const& cq,
  //    std::unique_ptr<grpc::ClientContext> context) {
  //  return google::cloud::internal::MakeStreamingWriteRpc<$request_type$,
  //  $response_type$>(
  //    cq, std::move(context),
  //    [this](grpc::ClientContext* context, $response_type$* response,
  //    grpc::CompletionQueue* cq) {
