...
class StubFactoryGenerator : public ClassGeneratorInterface {
 ...
 private:
  ...
  struct Pattern {
    Pattern(
        std::vector<PredicatedFragment<google::protobuf::MethodDescriptor>> f,
        std::function<bool(google::protobuf::MethodDescriptor const&)> p)
        : fragments(std::move(f)), predicate(std::move(p)) {}
    std::vector<PredicatedFragment<google::protobuf::MethodDescriptor>>
        fragments;
    std::function<bool(google::protobuf::MethodDescriptor const&)> predicate;
  };
