...
Status StubFactoryRestGenerator::GenerateHeader() {
  ...
  HeaderLocalIncludes({vars("stub_rest_header_path"),
                       "google/cloud/credentials.h", "google/cloud/version.h"});
...
Status StubFactoryRestGenerator::GenerateCc() {
  ...
  CcLocalIncludes(
      {vars("stub_factory_rest_header_path"), vars("logging_rest_header_path"),
       ...
       "google/cloud/common_options.h", "google/cloud/rest_options.h",
...
CreateDefault$stub_rest_class_name$(Options const& options) {
  ...
  std::shared_ptr<$stub_rest_class_name$> stub =
    std::make_shared<Default$stub_rest_class_name$>(internal::MergeOptions(
        options, auth_option));)""");
