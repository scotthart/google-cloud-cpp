...
std::string ConnectionImplGenerator::MethodDeclaration(
  ...
  future<Status>
  $method_name$(google::cloud::ExperimentalTag, $longrunning_operation_type$ const& operation) override;
)""";
    }
    return R"""(
...
$connection_class_name$Impl::$method_name$($request_type$ const& request) {
  ...
  return google::cloud::internal::AsyncLongRunningOperation<$longrunning_deduced_response_type$>(
    ...
    std::string start_function =
        absl::StrCat("\n", "StatusOr<$longrunning_operation_type$>",
                     R"""(
$connection_class_name$Impl::$method_name$(google::cloud::ExperimentalTag, google::cloud::NoAwaitTag, $request_type$ const& request) {
  auto current = google::cloud::internal::SaveCurrentOptions();)""",
                     R"""(
  return google::cloud::internal::RetryLoop(
    ...
    std::string await_function = absl::StrCat("\n", return_fragment,
                                              R"""(
$connection_class_name$Impl::$method_name$(google::cloud::ExperimentalTag, $longrunning_operation_type$ const& operation) {
  auto current = google::cloud::internal::SaveCurrentOptions();)""",
                                              R"""(
