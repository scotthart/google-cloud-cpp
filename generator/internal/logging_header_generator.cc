...
bool GenerateClientLoggingHeader(
    ...
    std::string* /* error */) {
  auto includes = BuildClientLoggingHeaderIncludes(service);
  auto namespaces = BuildClientLoggingHeaderNamespaces(service);

  p->Print(vars,
           "// Generated by the Codegen C++ plugin.\n"
           "// If you make any local changes, they will be lost.\n"
           "// source: $proto_file_name$\n"
           "#ifndef $logging_header_include_guard_const$\n"
           "#define $logging_header_include_guard_const$\n"
           "\n");
  ...
  p->Print(vars, "#endif  // $logging_header_include_guard_const$\n");
