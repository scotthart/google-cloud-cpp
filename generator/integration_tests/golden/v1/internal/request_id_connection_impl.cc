...
RequestIdServiceConnectionImpl::RenameFoo(google::cloud::ExperimentalTag, google::cloud::NoAwaitTag, google::test::requestid::v1::RenameFooRequest const& request) {
  auto current = google::cloud::internal::SaveCurrentOptions();
  return google::cloud::internal::RetryLoop(
      retry_policy(*current), backoff_policy(*current),
...
future<StatusOr<google::test::requestid::v1::Foo>>
RequestIdServiceConnectionImpl::RenameFoo(google::cloud::ExperimentalTag, google::longrunning::Operation const& operation) {
  auto current = google::cloud::internal::SaveCurrentOptions();
