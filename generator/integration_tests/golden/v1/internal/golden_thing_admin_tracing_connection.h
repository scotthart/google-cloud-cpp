...
class GoldenThingAdminTracingConnection
 ...
 public:
  ...
  CreateDatabase(google::cloud::ExperimentalTag, google::cloud::NoAwaitTag, google::test::admin::database::v1::CreateDatabaseRequest const& request) override;

  future<StatusOr<google::test::admin::database::v1::Database>>
  CreateDatabase(google::cloud::ExperimentalTag, google::longrunning::Operation const& operation) override;
  ...
  StatusOr<google::longrunning::Operation>
  UpdateDatabaseDdl(google::cloud::ExperimentalTag, google::cloud::NoAwaitTag, google::test::admin::database::v1::UpdateDatabaseDdlRequest const& request) override;

  future<StatusOr<google::test::admin::database::v1::UpdateDatabaseDdlMetadata>>
  UpdateDatabaseDdl(google::cloud::ExperimentalTag, google::longrunning::Operation const& operation) override;
  ...
  StatusOr<google::longrunning::Operation>
  CreateBackup(google::cloud::ExperimentalTag, google::cloud::NoAwaitTag, google::test::admin::database::v1::CreateBackupRequest const& request) override;

  future<StatusOr<google::test::admin::database::v1::Backup>>
  CreateBackup(google::cloud::ExperimentalTag, google::longrunning::Operation const& operation) override;
  ...
  StatusOr<google::longrunning::Operation>
  RestoreDatabase(google::cloud::ExperimentalTag, google::cloud::NoAwaitTag, google::test::admin::database::v1::RestoreDatabaseRequest const& request) override;

  future<StatusOr<google::test::admin::database::v1::Database>>
  RestoreDatabase(google::cloud::ExperimentalTag, google::longrunning::Operation const& operation) override;
  ...
  StatusOr<google::longrunning::Operation>
  LongRunningWithoutRouting(google::cloud::ExperimentalTag, google::cloud::NoAwaitTag, google::test::admin::database::v1::RestoreDatabaseRequest const& request) override;

  future<StatusOr<google::test::admin::database::v1::Database>>
  LongRunningWithoutRouting(google::cloud::ExperimentalTag, google::longrunning::Operation const& operation) override;
