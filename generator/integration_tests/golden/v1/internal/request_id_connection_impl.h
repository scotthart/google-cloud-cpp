...
class RequestIdServiceConnectionImpl
 ...
 public:
  ...
  RenameFoo(google::cloud::ExperimentalTag, google::cloud::NoAwaitTag, google::test::requestid::v1::RenameFooRequest const& request) override;

  future<StatusOr<google::test::requestid::v1::Foo>>
  RenameFoo(google::cloud::ExperimentalTag, google::longrunning::Operation const& operation) override;
