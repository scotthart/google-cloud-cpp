...
GoldenRestOnlyRestConnectionImpl::GetLocation(google::cloud::location::GetLocationRequest const& request) {
  auto current = google::cloud::internal::SaveCurrentOptions();
  return google::cloud::rest_internal::RestRetryLoop(
      retry_policy(*current), backoff_policy(*current),
...
GoldenRestOnlyRestConnectionImpl::GetIamPolicy(google::iam::v1::GetIamPolicyRequest const& request) {
  auto current = google::cloud::internal::SaveCurrentOptions();
  return google::cloud::rest_internal::RestRetryLoop(
      retry_policy(*current), backoff_policy(*current),
...
GoldenRestOnlyRestConnectionImpl::ListOperations(google::longrunning::ListOperationsRequest request) {
  ...
  return google::cloud::internal::MakePaginationRange<StreamRange<google::longrunning::Operation>>(
      ...
      [idempotency, function_name, stub = stub_,
       retry = std::shared_ptr<golden_v1::GoldenRestOnlyRetryPolicy>(retry_policy(*current)),
