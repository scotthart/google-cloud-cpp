...
StatusOr<google::longrunning::Operation>
  RequestIdServiceClient::RenameFoo(google::cloud::ExperimentalTag, google::cloud::NoAwaitTag, std::string const& name, std::string const& destination_foo_id, Options opts)
 {  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
  google::test::requestid::v1::RenameFooRequest request;
  request.set_name(name);
  request.set_destination_foo_id(destination_foo_id);
