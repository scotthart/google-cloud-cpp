...
GoldenThingAdminConnection::CreateDatabase(
    google::cloud::ExperimentalTag,    google::cloud::NoAwaitTag,    google::test::admin::database::v1::CreateDatabaseRequest const&) {
...
GoldenThingAdminConnection::UpdateDatabaseDdl(
  ...
  StatusOr<google::longrunning::Operation>
GoldenThingAdminConnection::UpdateDatabaseDdl(
    google::cloud::ExperimentalTag,    google::cloud::NoAwaitTag,    google::test::admin::database::v1::UpdateDatabaseDdlRequest const&) {
  return StatusOr<google::longrunning::Operation>(
    Status(StatusCode::kUnimplemented, "not implemented"));
}
...
GoldenThingAdminConnection::CreateBackup(
  ...
  StatusOr<google::longrunning::Operation>
GoldenThingAdminConnection::CreateBackup(
    google::cloud::ExperimentalTag,    google::cloud::NoAwaitTag,    google::test::admin::database::v1::CreateBackupRequest const&) {
  return StatusOr<google::longrunning::Operation>(
    Status(StatusCode::kUnimplemented, "not implemented"));
}
...
GoldenThingAdminConnection::RestoreDatabase(
  ...
  StatusOr<google::longrunning::Operation>
GoldenThingAdminConnection::RestoreDatabase(
    google::cloud::ExperimentalTag,    google::cloud::NoAwaitTag,    google::test::admin::database::v1::RestoreDatabaseRequest const&) {
  return StatusOr<google::longrunning::Operation>(
    Status(StatusCode::kUnimplemented, "not implemented"));
}
