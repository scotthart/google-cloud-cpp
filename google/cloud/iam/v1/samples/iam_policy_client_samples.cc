...
// clang-format off
// main-dox-marker: iam_v1::IAMPolicyClient
// clang-format on
namespace {
...
class CustomIdempotencyPolicy
 ...
 public:
  ...
  std::unique_ptr<google::cloud::iam_v1::IAMPolicyConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::iam_v1::IAMPolicyConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::iam_v1::IAMPolicyRetryPolicyOption>(
      google::cloud::iam_v1::IAMPolicyLimitedErrorCountRetryPolicy(3).clone())
  ...
  auto c3 = google::cloud::iam_v1::IAMPolicyClient(
    connection, google::cloud::Options{}.set<google::cloud::iam_v1::IAMPolicyRetryPolicyOption>(
      google::cloud::iam_v1::IAMPolicyLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::iam_v1::IAMPolicyClient(
      google::cloud::iam_v1::MakeIAMPolicyConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
