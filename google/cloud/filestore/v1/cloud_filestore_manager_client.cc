...
StatusOr<google::longrunning::Operation>
CloudFilestoreManagerClient::DeleteInstance(google::cloud::ExperimentalTag,
...
StatusOr<google::longrunning::Operation>
CloudFilestoreManagerClient::DeleteSnapshot(google::cloud::ExperimentalTag,
                                            google::cloud::NoAwaitTag,
                                            std::string const& name,
                                            Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
...
StatusOr<google::longrunning::Operation>
CloudFilestoreManagerClient::DeleteBackup(google::cloud::ExperimentalTag,
                                          google::cloud::NoAwaitTag,
                                          std::string const& name,
                                          Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
