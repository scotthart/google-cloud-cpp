...
DefaultRowAccessPoliciesRestStub::DefaultRowAccessPoliciesRestStub(Options options)
...
DefaultRowAccessPoliciesRestStub::ListRowAccessPolicies(
  ...
  return rest_internal::Get<google::cloud::cpp::bigquery::v2::ListRowAccessPoliciesResponse>(
      *service_, rest_context, request, false,
      absl::StrCat("/", "bigquery", "/", rest_internal::DetermineApiVersion("v2", options), "/", "projects", "/", request.project_id(), "/", "datasets", "/", request.dataset_id(), "/", "tables", "/", request.table_id(), "/", "rowAccessPolicies"),
