...
class RowAccessPoliciesRestStub {
 public:
  ...
  virtual StatusOr<google::cloud::cpp::bigquery::v2::Policy> GetIamPolicy(
      ...
      Options const& options, google::cloud::cpp::bigquery::row_access_policies::v2::GetIamPolicyRequest const& request) = 0;

  virtual StatusOr<google::cloud::cpp::bigquery::v2::ListRowAccessPoliciesResponse> ListRowAccessPolicies(
      google::cloud::rest_internal::RestContext& rest_context,
      Options const& options, google::cloud::cpp::bigquery::row_access_policies::v2::ListRowAccessPoliciesRequest const& request) = 0;

  virtual StatusOr<google::cloud::cpp::bigquery::v2::TestIamPermissionsResponse> TestIamPermissions(
      google::cloud::rest_internal::RestContext& rest_context,
      Options const& options, google::cloud::cpp::bigquery::row_access_policies::v2::TestIamPermissionsRequest const& request) = 0;
};
