...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERY_PROJECTS_V2_MOCKS_MOCK_PROJECTS_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERY_PROJECTS_V2_MOCKS_MOCK_PROJECTS_CONNECTION_H
...
namespace google {
namespace cloud {
namespace bigquery_projects_v2_mocks {
 ...
 */
class MockProjectsConnection : public bigquery_projects_v2::ProjectsConnection {
 public:
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERY_PROJECTS_V2_MOCKS_MOCK_PROJECTS_CONNECTION_H
