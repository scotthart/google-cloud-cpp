...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERY_MODELS_V2_MOCKS_MOCK_MODELS_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERY_MODELS_V2_MOCKS_MOCK_MODELS_CONNECTION_H
...
namespace google {
namespace cloud {
namespace bigquery_models_v2_mocks {
GOOGLE_CLOUD_CPP_INLINE_NAMESPACE_BEGIN

/**
 * A class to mock `ModelsConnection`.
 *
 * Application developers may want to test their code with simulated responses,
 * including errors, from an object of type `ModelsClient`. To do so,
 * construct an object of type `ModelsClient` with an instance of this
 ...
 */
class MockModelsConnection : public bigquery_models_v2::ModelsConnection {
 public:
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERY_MODELS_V2_MOCKS_MOCK_MODELS_CONNECTION_H
