...
class CustomIdempotencyPolicy
 ...
 public:
  ...
  std::unique_ptr<
      google::cloud::bigquery_jobs_v2::JobsConnectionIdempotencyPolicy>
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto c3 = google::cloud::bigquery_jobs_v2::JobsClient(
      ...
      google::cloud::Options{}
          .set<google::cloud::bigquery_jobs_v2::JobsRetryPolicyOption>(
              google::cloud::bigquery_jobs_v2::JobsLimitedTimeRetryPolicy(
