...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERY_JOBS_V2_MOCKS_MOCK_JOBS_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERY_JOBS_V2_MOCKS_MOCK_JOBS_CONNECTION_H
...
namespace google {
namespace cloud {
namespace bigquery_jobs_v2_mocks {
 ...
 */
class MockJobsConnection : public bigquery_jobs_v2::JobsConnection {
 public:
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERY_JOBS_V2_MOCKS_MOCK_JOBS_CONNECTION_H
