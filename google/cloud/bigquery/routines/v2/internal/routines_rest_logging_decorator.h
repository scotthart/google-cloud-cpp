...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERY_ROUTINES_V2_INTERNAL_ROUTINES_REST_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERY_ROUTINES_V2_INTERNAL_ROUTINES_REST_LOGGING_DECORATOR_H
...
class RoutinesRestLogging : public RoutinesRestStub {
 public:
  ~RoutinesRestLogging() override = default;
  RoutinesRestLogging(std::shared_ptr<RoutinesRestStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERY_ROUTINES_V2_INTERNAL_ROUTINES_REST_LOGGING_DECORATOR_H
