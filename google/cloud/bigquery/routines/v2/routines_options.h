 ...
 */
struct RoutinesRetryPolicyOption {
  using Type = std::shared_ptr<RoutinesRetryPolicy>;
};
 ...
 * @ingroup google-cloud-bigquery-options
 */
struct RoutinesBackoffPolicyOption {
 ...
 * @ingroup google-cloud-bigquery-options
 */
struct RoutinesConnectionIdempotencyPolicyOption {
  using Type = std::shared_ptr<RoutinesConnectionIdempotencyPolicy>;
};

/**
 * The options applicable to Routines.
 *
 * @ingroup google-cloud-bigquery-options
 */
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERY_ROUTINES_V2_ROUTINES_OPTIONS_H
