...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERY_ROUTINES_V2_MOCKS_MOCK_ROUTINES_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERY_ROUTINES_V2_MOCKS_MOCK_ROUTINES_CONNECTION_H
...
namespace google {
namespace cloud {
namespace bigquery_routines_v2_mocks {
GOOGLE_CLOUD_CPP_INLINE_NAMESPACE_BEGIN

/**
 * A class to mock `RoutinesConnection`.
 *
 * Application developers may want to test their code with simulated responses,
 * including errors, from an object of type `RoutinesClient`. To do so,
 * construct an object of type `RoutinesClient` with an instance of this
 ...
 */
class MockRoutinesConnection : public bigquery_routines_v2::RoutinesConnection {
 public:
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERY_ROUTINES_V2_MOCKS_MOCK_ROUTINES_CONNECTION_H
