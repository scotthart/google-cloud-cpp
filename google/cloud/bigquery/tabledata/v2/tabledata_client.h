...
class TabledataClient {
 public:
  ...
  /// [google.cloud.cpp.bigquery.tabledata.v2.InsertAllRequest]: @cloud_cpp_reference_link{google/cloud/bigquery/tabledata/v2/tabledata.proto#L64}
  /// [google.cloud.cpp.bigquery.v2.TableDataInsertAllResponse]: @cloud_cpp_reference_link{google/cloud/bigquery/v2/internal/common_012.proto#L79}
  ///
  // clang-format on
  ...
  /// [`StatusOr`]: @ref google::cloud::StatusOr
  /// [`Status`]: @ref google::cloud::Status
  /// [google.cloud.cpp.bigquery.tabledata.v2.ListTabledataRequest]: @cloud_cpp_reference_link{google/cloud/bigquery/tabledata/v2/tabledata.proto#L84}
  /// [google.cloud.cpp.bigquery.v2.TableDataList]: @cloud_cpp_reference_link{google/cloud/bigquery/v2/internal/common_012.proto#L95}
  ///
  // clang-format on
