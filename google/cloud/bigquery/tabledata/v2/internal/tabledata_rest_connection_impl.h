...
class TabledataRestConnectionImpl
 ...
 private:
  ...
  std::shared_ptr<bigquery_tabledata_v2_internal::TabledataRestStub> stub_;
  Options options_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERY_TABLEDATA_V2_INTERNAL_TABLEDATA_REST_CONNECTION_IMPL_H
