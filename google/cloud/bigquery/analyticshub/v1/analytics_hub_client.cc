...
AnalyticsHubServiceClient::SubscribeDataExchange(google::cloud::ExperimentalTag,
...
StatusOr<google::longrunning::Operation>
AnalyticsHubServiceClient::RefreshSubscription(google::cloud::ExperimentalTag,
                                               google::cloud::NoAwaitTag,
                                               std::string const& name,
                                               Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
...
StatusOr<google::longrunning::Operation>
AnalyticsHubServiceClient::DeleteSubscription(google::cloud::ExperimentalTag,
                                              google::cloud::NoAwaitTag,
                                              std::string const& name,
                                              Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
