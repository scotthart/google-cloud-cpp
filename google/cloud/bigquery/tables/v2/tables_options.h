 ...
 */
struct TablesRetryPolicyOption {
  using Type = std::shared_ptr<TablesRetryPolicy>;
};
 ...
 * @ingroup google-cloud-bigquery-options
 */
struct TablesBackoffPolicyOption {
 ...
 * @ingroup google-cloud-bigquery-options
 */
struct TablesConnectionIdempotencyPolicyOption {
  using Type = std::shared_ptr<TablesConnectionIdempotencyPolicy>;
};

/**
 * The options applicable to Tables.
 *
 * @ingroup google-cloud-bigquery-options
 */
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_BIGQUERY_TABLES_V2_TABLES_OPTIONS_H
