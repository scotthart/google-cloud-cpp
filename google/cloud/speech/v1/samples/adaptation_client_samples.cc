...
// clang-format off
// main-dox-marker: speech_v1::AdaptationClient
// clang-format on
namespace {
...
class CustomIdempotencyPolicy
   : public google::cloud::speech_v1::AdaptationConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::speech_v1::AdaptationConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::speech_v1::AdaptationConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::speech_v1::AdaptationRetryPolicyOption>(
      google::cloud::speech_v1::AdaptationLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::speech_v1::AdaptationBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::speech_v1::MakeAdaptationConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::speech_v1::AdaptationClient(connection);
  auto c2 = google::cloud::speech_v1::AdaptationClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::speech_v1::AdaptationClient(
    connection, google::cloud::Options{}.set<google::cloud::speech_v1::AdaptationRetryPolicyOption>(
      google::cloud::speech_v1::AdaptationLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::speech_v1::AdaptationRetryPolicyOption>(
  //       google::cloud::speech_v1::AdaptationLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
