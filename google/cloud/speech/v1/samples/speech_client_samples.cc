...
// clang-format off
// main-dox-marker: speech_v1::SpeechClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::speech_v1::SpeechClient(
...
class CustomIdempotencyPolicy
 ...
 public:
  ...
  std::unique_ptr<google::cloud::speech_v1::SpeechConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::speech_v1::SpeechConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::speech_v1::SpeechRetryPolicyOption>(
      google::cloud::speech_v1::SpeechLimitedErrorCountRetryPolicy(3).clone())
  ...
  auto c3 = google::cloud::speech_v1::SpeechClient(
    connection, google::cloud::Options{}.set<google::cloud::speech_v1::SpeechRetryPolicyOption>(
      google::cloud::speech_v1::SpeechLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::speech_v1::SpeechPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::speech_v1::SpeechRetryPolicyOption::Type,
            google::cloud::speech_v1::SpeechBackoffPolicyOption::Type>(
