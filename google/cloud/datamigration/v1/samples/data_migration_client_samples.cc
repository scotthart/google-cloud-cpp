...
// clang-format off
// main-dox-marker: datamigration_v1::DataMigrationServiceClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::datamigration_v1::DataMigrationServiceClient(
      google::cloud::datamigration_v1::MakeDataMigrationServiceConnection(options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::datamigration_v1::DataMigrationServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::datamigration_v1::DataMigrationServiceConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::datamigration_v1::DataMigrationServiceConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::datamigration_v1::DataMigrationServiceRetryPolicyOption>(
      google::cloud::datamigration_v1::DataMigrationServiceLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::datamigration_v1::DataMigrationServiceBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::datamigration_v1::MakeDataMigrationServiceConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::datamigration_v1::DataMigrationServiceClient(connection);
  auto c2 = google::cloud::datamigration_v1::DataMigrationServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::datamigration_v1::DataMigrationServiceClient(
    connection, google::cloud::Options{}.set<google::cloud::datamigration_v1::DataMigrationServiceRetryPolicyOption>(
      google::cloud::datamigration_v1::DataMigrationServiceLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::datamigration_v1::DataMigrationServicePollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::datamigration_v1::DataMigrationServiceRetryPolicyOption::Type,
            google::cloud::datamigration_v1::DataMigrationServiceBackoffPolicyOption::Type>(
            google::cloud::datamigration_v1::DataMigrationServiceLimitedTimeRetryPolicy(
