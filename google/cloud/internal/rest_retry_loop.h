...
namespace internal {
#if 0
inline void ConfigureRestRequest(rest_internal::RestRequest&, Options const&) {

}

template <typename Functor, typename Request,
          typename RpcState = rest_internal::RestRequest,
          typename ConfigureRpcStateFn = ConfigureRestRequest,
