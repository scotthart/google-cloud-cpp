...
#include "google/cloud/internal/oauth2/anonymous_credentials.h"
#include "google/cloud/internal/oauth2/authorized_user_credentials.h"
#include "google/cloud/internal/oauth2/compute_engine_credentials.h"
#include "google/cloud/internal/oauth2/google_application_default_credentials_file.h"
#include "google/cloud/internal/oauth2/service_account_credentials.h"
...
StatusOr<std::unique_ptr<Credentials>> LoadCredsFromPath(
    ...
    internal::ChannelOptions const& options) {
...
CreateAuthorizedUserCredentialsFromJsonContents(
    std::string const& contents, internal::ChannelOptions const& options) {
