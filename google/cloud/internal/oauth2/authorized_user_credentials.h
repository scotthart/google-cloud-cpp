...
#include "google/cloud/internal/http_response.h"
...
ParseAuthorizedUserRefreshResponse(internal::HttpResponse const& response,
...
class AuthorizedUserCredentials : public Credentials {
 public:
  explicit AuthorizedUserCredentials(
      ...
      internal::ChannelOptions const& channel_options = {})
      : clock_() {
    HttpRequestBuilderType request_builder(
        info.token_uri, internal::GetDefaultCurlHandleFactory(
