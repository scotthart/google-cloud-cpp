...
class CustomIdempotencyPolicy
   : public google::cloud::logging_v2::LoggingServiceV2ConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::logging_v2::LoggingServiceV2ConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::logging_v2::LoggingServiceV2ConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::logging_v2::LoggingServiceV2RetryPolicyOption>(
      google::cloud::logging_v2::LoggingServiceV2LimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::logging_v2::LoggingServiceV2BackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::logging_v2::MakeLoggingServiceV2Connection(options);
  ...
  auto c3 = google::cloud::logging_v2::LoggingServiceV2Client(
    connection, google::cloud::Options{}.set<google::cloud::logging_v2::LoggingServiceV2RetryPolicyOption>(
      google::cloud::logging_v2::LoggingServiceV2LimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));
