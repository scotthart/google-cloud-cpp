...
// clang-format off
// main-dox-marker: logging_v2::ConfigServiceV2Client
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::logging_v2::ConfigServiceV2Client(
...
class CustomIdempotencyPolicy
   : public google::cloud::logging_v2::ConfigServiceV2ConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::logging_v2::ConfigServiceV2ConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::logging_v2::ConfigServiceV2ConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::logging_v2::ConfigServiceV2RetryPolicyOption>(
      google::cloud::logging_v2::ConfigServiceV2LimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::logging_v2::ConfigServiceV2BackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::logging_v2::MakeConfigServiceV2Connection(options);
  ...
  auto c3 = google::cloud::logging_v2::ConfigServiceV2Client(
    connection, google::cloud::Options{}.set<google::cloud::logging_v2::ConfigServiceV2RetryPolicyOption>(
      google::cloud::logging_v2::ConfigServiceV2LimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::logging_v2::ConfigServiceV2PollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::logging_v2::ConfigServiceV2RetryPolicyOption::Type,
            google::cloud::logging_v2::ConfigServiceV2BackoffPolicyOption::Type>(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::logging_v2::ConfigServiceV2Client(
      google::cloud::logging_v2::MakeConfigServiceV2Connection(options));
  }
  //! [with-service-account]
  (argv.at(0));
