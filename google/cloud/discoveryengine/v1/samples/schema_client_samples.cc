...
// clang-format off
// main-dox-marker: discoveryengine_v1::SchemaServiceClient
// lro-marker: true
// clang-format on
namespace {
...
class CustomIdempotencyPolicy
   : public google::cloud::discoveryengine_v1::SchemaServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::discoveryengine_v1::SchemaServiceConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::discoveryengine_v1::SchemaServiceConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::discoveryengine_v1::SchemaServiceRetryPolicyOption>(
      google::cloud::discoveryengine_v1::SchemaServiceLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::discoveryengine_v1::SchemaServiceBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::discoveryengine_v1::MakeSchemaServiceConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::discoveryengine_v1::SchemaServiceClient(connection);
  auto c2 = google::cloud::discoveryengine_v1::SchemaServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::discoveryengine_v1::SchemaServiceClient(
    connection, google::cloud::Options{}.set<google::cloud::discoveryengine_v1::SchemaServiceRetryPolicyOption>(
      google::cloud::discoveryengine_v1::SchemaServiceLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::discoveryengine_v1::SchemaServiceRetryPolicyOption>(
  //       google::cloud::discoveryengine_v1::SchemaServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::discoveryengine_v1::SchemaServicePollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::discoveryengine_v1::SchemaServiceRetryPolicyOption::Type,
            google::cloud::discoveryengine_v1::SchemaServiceBackoffPolicyOption::Type>(
            google::cloud::discoveryengine_v1::SchemaServiceLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::discoveryengine_v1::SchemaServiceClient(
      google::cloud::discoveryengine_v1::MakeSchemaServiceConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
