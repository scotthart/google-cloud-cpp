...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DISCOVERYENGINE_V1_RANK_CLIENT_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DISCOVERYENGINE_V1_RANK_CLIENT_H
...
class RankServiceClient {
 public:
  ...
  RankServiceClient(RankServiceClient const&) = default;
  RankServiceClient& operator=(RankServiceClient const&) = default;
  RankServiceClient(RankServiceClient&&) = default;
  RankServiceClient& operator=(RankServiceClient&&) = default;
  ///@}
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DISCOVERYENGINE_V1_RANK_CLIENT_H
