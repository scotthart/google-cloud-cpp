...
class CustomIdempotencyPolicy
   : public google::cloud::dialogflow_es::DocumentsConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::dialogflow_es::DocumentsConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::dialogflow_es::DocumentsConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::dialogflow_es::DocumentsRetryPolicyOption>(
      google::cloud::dialogflow_es::DocumentsLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::dialogflow_es::DocumentsBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::dialogflow_es::MakeDocumentsConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::dialogflow_es::DocumentsClient(connection);
  auto c2 = google::cloud::dialogflow_es::DocumentsClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::dialogflow_es::DocumentsClient(
    connection, google::cloud::Options{}.set<google::cloud::dialogflow_es::DocumentsRetryPolicyOption>(
      google::cloud::dialogflow_es::DocumentsLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::dialogflow_es::DocumentsPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::dialogflow_es::DocumentsRetryPolicyOption::Type,
            google::cloud::dialogflow_es::DocumentsBackoffPolicyOption::Type>(
            google::cloud::dialogflow_es::DocumentsLimitedTimeRetryPolicy(
