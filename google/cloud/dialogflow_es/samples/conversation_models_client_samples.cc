...
class CustomIdempotencyPolicy
   : public google::cloud::dialogflow_es::ConversationModelsConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::dialogflow_es::ConversationModelsConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::dialogflow_es::ConversationModelsConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::dialogflow_es::ConversationModelsRetryPolicyOption>(
      google::cloud::dialogflow_es::ConversationModelsLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::dialogflow_es::ConversationModelsBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::dialogflow_es::MakeConversationModelsConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::dialogflow_es::ConversationModelsClient(connection);
  auto c2 = google::cloud::dialogflow_es::ConversationModelsClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::dialogflow_es::ConversationModelsClient(
    connection, google::cloud::Options{}.set<google::cloud::dialogflow_es::ConversationModelsRetryPolicyOption>(
      google::cloud::dialogflow_es::ConversationModelsLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::dialogflow_es::ConversationModelsRetryPolicyOption>(
  //       google::cloud::dialogflow_es::ConversationModelsLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::dialogflow_es::ConversationModelsPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::dialogflow_es::ConversationModelsRetryPolicyOption::Type,
            google::cloud::dialogflow_es::ConversationModelsBackoffPolicyOption::Type>(
            google::cloud::dialogflow_es::ConversationModelsLimitedTimeRetryPolicy(
