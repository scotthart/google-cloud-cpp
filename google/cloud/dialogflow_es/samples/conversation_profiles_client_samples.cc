...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::dialogflow_es::ConversationProfilesClient(
      google::cloud::dialogflow_es::MakeConversationProfilesConnection(options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::dialogflow_es::ConversationProfilesConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::dialogflow_es::ConversationProfilesConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::dialogflow_es::ConversationProfilesConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::dialogflow_es::ConversationProfilesRetryPolicyOption>(
      google::cloud::dialogflow_es::ConversationProfilesLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::dialogflow_es::ConversationProfilesBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::dialogflow_es::MakeConversationProfilesConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::dialogflow_es::ConversationProfilesClient(connection);
  auto c2 = google::cloud::dialogflow_es::ConversationProfilesClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::dialogflow_es::ConversationProfilesClient(
    connection, google::cloud::Options{}.set<google::cloud::dialogflow_es::ConversationProfilesRetryPolicyOption>(
      google::cloud::dialogflow_es::ConversationProfilesLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::dialogflow_es::ConversationProfilesRetryPolicyOption>(
  //       google::cloud::dialogflow_es::ConversationProfilesLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::dialogflow_es::ConversationProfilesPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::dialogflow_es::ConversationProfilesRetryPolicyOption::Type,
            google::cloud::dialogflow_es::ConversationProfilesBackoffPolicyOption::Type>(
            google::cloud::dialogflow_es::ConversationProfilesLimitedTimeRetryPolicy(
