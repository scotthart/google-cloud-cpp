...
class CustomIdempotencyPolicy
   : public google::cloud::dialogflow_es::ConversationsConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::dialogflow_es::ConversationsConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::dialogflow_es::ConversationsConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::dialogflow_es::ConversationsRetryPolicyOption>(
      google::cloud::dialogflow_es::ConversationsLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::dialogflow_es::ConversationsBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::dialogflow_es::MakeConversationsConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::dialogflow_es::ConversationsClient(connection);
  auto c2 = google::cloud::dialogflow_es::ConversationsClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::dialogflow_es::ConversationsClient(
    connection, google::cloud::Options{}.set<google::cloud::dialogflow_es::ConversationsRetryPolicyOption>(
      google::cloud::dialogflow_es::ConversationsLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::dialogflow_es::ConversationsRetryPolicyOption>(
  //       google::cloud::dialogflow_es::ConversationsLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
