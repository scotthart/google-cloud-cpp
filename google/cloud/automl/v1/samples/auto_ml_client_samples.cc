...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::automl_v1::AutoMlClient(
      google::cloud::automl_v1::MakeAutoMlConnection(options));
  //! [set-client-endpoint]
}
...
class CustomIdempotencyPolicy
 ...
 public:
  ...
  std::unique_ptr<google::cloud::automl_v1::AutoMlConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::automl_v1::AutoMlConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::automl_v1::AutoMlRetryPolicyOption>(
      google::cloud::automl_v1::AutoMlLimitedErrorCountRetryPolicy(3).clone())
  ...
  auto c3 = google::cloud::automl_v1::AutoMlClient(
    connection, google::cloud::Options{}.set<google::cloud::automl_v1::AutoMlRetryPolicyOption>(
      google::cloud::automl_v1::AutoMlLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::automl_v1::AutoMlPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::automl_v1::AutoMlRetryPolicyOption::Type,
            google::cloud::automl_v1::AutoMlBackoffPolicyOption::Type>(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::automl_v1::AutoMlClient(
      google::cloud::automl_v1::MakeAutoMlConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
