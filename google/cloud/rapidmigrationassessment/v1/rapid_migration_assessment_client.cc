...
StatusOr<google::longrunning::Operation>
RapidMigrationAssessmentClient::DeleteCollector(google::cloud::ExperimentalTag,
...
StatusOr<google::longrunning::Operation>
RapidMigrationAssessmentClient::ResumeCollector(google::cloud::ExperimentalTag,
                                                google::cloud::NoAwaitTag,
                                                std::string const& name,
                                                Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
...
StatusOr<google::longrunning::Operation>
RapidMigrationAssessmentClient::PauseCollector(google::cloud::ExperimentalTag,
                                               google::cloud::NoAwaitTag,
                                               std::string const& name,
                                               Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
