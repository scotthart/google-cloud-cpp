...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SPANNER_ADMIN_INTERNAL_INSTANCE_ADMIN_TRACING_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SPANNER_ADMIN_INTERNAL_INSTANCE_ADMIN_TRACING_STUB_H
...
class InstanceAdminTracingStub : public InstanceAdminStub {
 public:
  ...
  explicit InstanceAdminTracingStub(std::shared_ptr<InstanceAdminStub> child);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SPANNER_ADMIN_INTERNAL_INSTANCE_ADMIN_TRACING_STUB_H
