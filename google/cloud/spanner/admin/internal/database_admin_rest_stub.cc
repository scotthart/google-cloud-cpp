...
DefaultDatabaseAdminRestStub::ListDatabases(
  ...
  return rest_internal::Get<google::spanner::admin::database::v1::ListDatabasesResponse>(
  ...
  std::thread t{[](
      ...
      p.set_value(rest_internal::Patch<google::longrunning::Operation>(
          *service, *rest_context, request.database(),
          false,
          absl::StrCat("/", rest_internal::DetermineApiVersion("v1", *options), "/", request.database().name()), std::move(query_params)));
    },
    std::move(p), service_, request, std::move(rest_context),
    std::move(options)};
  return f.then([t = std::move(t), cq](auto f) mutable {
...
DefaultDatabaseAdminRestStub::GetDatabaseDdl(
  ...
  std::vector<std::pair<std::string, std::string>> query_params;
  return rest_internal::Get<google::spanner::admin::database::v1::GetDatabaseDdlResponse>(
      *service_, rest_context, request, false,
      absl::StrCat("/", rest_internal::DetermineApiVersion("v1", options), "/", request.database(), "/", "ddl"), std::move(query_params));
}

StatusOr<google::iam::v1::Policy>
DefaultDatabaseAdminRestStub::SetIamPolicy(
      google::cloud::rest_internal::RestContext& rest_context,
      Options const& options,
...
StatusOr<google::iam::v1::Policy>
DefaultDatabaseAdminRestStub::GetIamPolicy(
      google::cloud::rest_internal::RestContext& rest_context,
      Options const& options,
...
DefaultDatabaseAdminRestStub::AsyncCopyBackup(
  ...
  std::thread t{[](
      ...
      p.set_value(rest_internal::Post<google::longrunning::Operation>(
          *service, *rest_context, request,
          false,
          absl::StrCat("/", rest_internal::DetermineApiVersion("v1", *options), "/", request.parent(), "/", "backups", ":copy"), std::move(query_params)));
    },
    std::move(p), service_, request, std::move(rest_context),
    std::move(options)};
  return f.then([t = std::move(t), cq](auto f) mutable {
...
DefaultDatabaseAdminRestStub::ListBackups(
  ...
  query_params.push_back({"page_token", request.page_token()});
  query_params = rest_internal::TrimEmptyQueryParameters(std::move(query_params));
  return rest_internal::Get<google::spanner::admin::database::v1::ListBackupsResponse>(
      *service_, rest_context, request, false,
      absl::StrCat("/", rest_internal::DetermineApiVersion("v1", options), "/", request.parent(), "/", "backups"), std::move(query_params));
}
...
DefaultDatabaseAdminRestStub::ListDatabaseOperations(
  ...
  query_params.push_back({"page_token", request.page_token()});
  query_params = rest_internal::TrimEmptyQueryParameters(std::move(query_params));
  return rest_internal::Get<google::spanner::admin::database::v1::ListDatabaseOperationsResponse>(
      *service_, rest_context, request, false,
...
DefaultDatabaseAdminRestStub::ListBackupOperations(
  ...
  query_params.push_back({"page_token", request.page_token()});
  query_params = rest_internal::TrimEmptyQueryParameters(std::move(query_params));
  return rest_internal::Get<google::spanner::admin::database::v1::ListBackupOperationsResponse>(
      *service_, rest_context, request, false,
...
DefaultDatabaseAdminRestStub::ListDatabaseRoles(
  ...
  query_params.push_back({"page_token", request.page_token()});
  query_params = rest_internal::TrimEmptyQueryParameters(std::move(query_params));
  return rest_internal::Get<google::spanner::admin::database::v1::ListDatabaseRolesResponse>(
      *service_, rest_context, request, false,
      absl::StrCat("/", rest_internal::DetermineApiVersion("v1", options), "/", request.parent(), "/", "databaseRoles"), std::move(query_params));
}
...
DefaultDatabaseAdminRestStub::CreateBackupSchedule(
  ...
  query_params = rest_internal::TrimEmptyQueryParameters(std::move(query_params));
  return rest_internal::Post<google::spanner::admin::database::v1::BackupSchedule>(
      *service_, rest_context, request.backup_schedule(), false,
      absl::StrCat("/", rest_internal::DetermineApiVersion("v1", options), "/", request.parent(), "/", "backupSchedules"), std::move(query_params));
}
...
DefaultDatabaseAdminRestStub::GetBackupSchedule(
  ...
  std::vector<std::pair<std::string, std::string>> query_params;
  return rest_internal::Get<google::spanner::admin::database::v1::BackupSchedule>(
      *service_, rest_context, request, false,
      absl::StrCat("/", rest_internal::DetermineApiVersion("v1", options), "/", request.name()), std::move(query_params));
}
...
DefaultDatabaseAdminRestStub::UpdateBackupSchedule(
  ...
  std::vector<std::pair<std::string, std::string>> query_params;
  return rest_internal::Patch<google::spanner::admin::database::v1::BackupSchedule>(
      *service_, rest_context, request.backup_schedule(), false,
      absl::StrCat("/", rest_internal::DetermineApiVersion("v1", options), "/", request.backup_schedule().name()), std::move(query_params));
}
...
DefaultDatabaseAdminRestStub::ListBackupSchedules(
  ...
  query_params.push_back({"page_token", request.page_token()});
  query_params = rest_internal::TrimEmptyQueryParameters(std::move(query_params));
  return rest_internal::Get<google::spanner::admin::database::v1::ListBackupSchedulesResponse>(
      *service_, rest_context, request, false,
      absl::StrCat("/", rest_internal::DetermineApiVersion("v1", options), "/", request.parent(), "/", "backupSchedules"), std::move(query_params));
}
...
future<Status>
DefaultDatabaseAdminRestStub::AsyncCancelOperation(
    google::cloud::CompletionQueue& cq,
    std::unique_ptr<rest_internal::RestContext> rest_context,
    google::cloud::internal::ImmutableOptions options,
    google::longrunning::CancelOperationRequest const& request) {
