...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SPANNER_ADMIN_INTERNAL_DATABASE_ADMIN_REST_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SPANNER_ADMIN_INTERNAL_DATABASE_ADMIN_REST_LOGGING_DECORATOR_H
...
class DatabaseAdminRestLogging : public DatabaseAdminRestStub {
 public:
  ~DatabaseAdminRestLogging() override = default;
  DatabaseAdminRestLogging(std::shared_ptr<DatabaseAdminRestStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SPANNER_ADMIN_INTERNAL_DATABASE_ADMIN_REST_LOGGING_DECORATOR_H
