...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SPANNER_ADMIN_INTERNAL_DATABASE_ADMIN_TRACING_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SPANNER_ADMIN_INTERNAL_DATABASE_ADMIN_TRACING_STUB_H
...
class DatabaseAdminTracingStub : public DatabaseAdminStub {
 public:
  ...
  explicit DatabaseAdminTracingStub(std::shared_ptr<DatabaseAdminStub> child);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SPANNER_ADMIN_INTERNAL_DATABASE_ADMIN_TRACING_STUB_H
