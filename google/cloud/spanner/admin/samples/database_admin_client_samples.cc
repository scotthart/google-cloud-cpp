...
class CustomIdempotencyPolicy
   : public google::cloud::spanner_admin::DatabaseAdminConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::spanner_admin::DatabaseAdminConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::spanner_admin::DatabaseAdminConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::spanner_admin::DatabaseAdminRetryPolicyOption>(
      google::cloud::spanner_admin::DatabaseAdminLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::spanner_admin::DatabaseAdminBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::spanner_admin::MakeDatabaseAdminConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::spanner_admin::DatabaseAdminClient(connection);
  auto c2 = google::cloud::spanner_admin::DatabaseAdminClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::spanner_admin::DatabaseAdminClient(
    connection, google::cloud::Options{}.set<google::cloud::spanner_admin::DatabaseAdminRetryPolicyOption>(
      google::cloud::spanner_admin::DatabaseAdminLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::spanner_admin::DatabaseAdminRetryPolicyOption>(
  //       google::cloud::spanner_admin::DatabaseAdminLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::spanner_admin::DatabaseAdminPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::spanner_admin::DatabaseAdminRetryPolicyOption::Type,
            google::cloud::spanner_admin::DatabaseAdminBackoffPolicyOption::Type>(
