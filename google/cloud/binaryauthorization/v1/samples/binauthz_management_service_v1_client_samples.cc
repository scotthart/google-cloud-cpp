...
// clang-format off
// main-dox-marker: binaryauthorization_v1::BinauthzManagementServiceV1Client
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::binaryauthorization_v1::BinauthzManagementServiceV1Client(
