...
class CustomIdempotencyPolicy
 ...
 public:
  ...
  std::unique_ptr<google::cloud::batch_v1::BatchServiceConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::batch_v1::BatchServiceConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::batch_v1::BatchServiceRetryPolicyOption>(
      google::cloud::batch_v1::BatchServiceLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::batch_v1::BatchServiceBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::batch_v1::MakeBatchServiceConnection(options);
  ...
  auto c3 = google::cloud::batch_v1::BatchServiceClient(
    connection, google::cloud::Options{}.set<google::cloud::batch_v1::BatchServiceRetryPolicyOption>(
      google::cloud::batch_v1::BatchServiceLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::batch_v1::BatchServicePollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::batch_v1::BatchServiceRetryPolicyOption::Type,
            google::cloud::batch_v1::BatchServiceBackoffPolicyOption::Type>(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::batch_v1::BatchServiceClient(
      google::cloud::batch_v1::MakeBatchServiceConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
