...
// clang-format off
// main-dox-marker: metastore_v1::DataprocMetastoreClient
// lro-marker: true
// clang-format on
namespace {
...
class CustomIdempotencyPolicy
   : public google::cloud::metastore_v1::DataprocMetastoreConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::metastore_v1::DataprocMetastoreConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::metastore_v1::DataprocMetastoreConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::metastore_v1::DataprocMetastoreRetryPolicyOption>(
      google::cloud::metastore_v1::DataprocMetastoreLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::metastore_v1::DataprocMetastoreBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::metastore_v1::MakeDataprocMetastoreConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::metastore_v1::DataprocMetastoreClient(connection);
  auto c2 = google::cloud::metastore_v1::DataprocMetastoreClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::metastore_v1::DataprocMetastoreClient(
    connection, google::cloud::Options{}.set<google::cloud::metastore_v1::DataprocMetastoreRetryPolicyOption>(
      google::cloud::metastore_v1::DataprocMetastoreLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::metastore_v1::DataprocMetastoreRetryPolicyOption>(
  //       google::cloud::metastore_v1::DataprocMetastoreLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::metastore_v1::DataprocMetastorePollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::metastore_v1::DataprocMetastoreRetryPolicyOption::Type,
            google::cloud::metastore_v1::DataprocMetastoreBackoffPolicyOption::Type>(
            google::cloud::metastore_v1::DataprocMetastoreLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::metastore_v1::DataprocMetastoreClient(
      google::cloud::metastore_v1::MakeDataprocMetastoreConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
