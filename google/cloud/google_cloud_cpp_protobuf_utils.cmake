...
function (google_cloud_cpp_protobuf_utils_add_test fname labels)
    ...
    target_link_libraries(
        ${target}
        PRIVATE google_cloud_cpp_testing google-cloud-cpp::common absl::variant
...
if (BUILD_TESTING)
    ...
    # # List the unit tests, then setup the targets and dependencies.
    # set(google_cloud_cpp_grpc_utils_integration_tests # cmake-format: sort
    ...
    # export_list_to_bazel( "google_cloud_cpp_grpc_utils_integration_tests.bzl"
    ...
    # "integration-test-production") endforeach ()
    ...
    # Generate a target for each benchmark. foreach (fname
    # ${google_cloud_cpp_grpc_utils_benchmarks})
    # google_cloud_cpp_add_executable(target "common" "${fname}") add_test(NAME
    # ${target} COMMAND ${target}) target_link_libraries( ${target} PRIVATE
    # google-cloud-cpp::grpc_utils google-cloud-cpp::common
    # benchmark::benchmark_main) google_cloud_cpp_add_common_options(${target})
    # endforeach ()
endif ()
