...
// clang-format off
// main-dox-marker: gkehub_v1::GkeHubClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::gkehub_v1::GkeHubClient(
...
class CustomIdempotencyPolicy
 ...
 public:
  ...
  std::unique_ptr<google::cloud::gkehub_v1::GkeHubConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::gkehub_v1::GkeHubConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::gkehub_v1::GkeHubRetryPolicyOption>(
      google::cloud::gkehub_v1::GkeHubLimitedErrorCountRetryPolicy(3).clone())
  ...
  auto c3 = google::cloud::gkehub_v1::GkeHubClient(
    connection, google::cloud::Options{}.set<google::cloud::gkehub_v1::GkeHubRetryPolicyOption>(
      google::cloud::gkehub_v1::GkeHubLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::gkehub_v1::GkeHubPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::gkehub_v1::GkeHubRetryPolicyOption::Type,
            google::cloud::gkehub_v1::GkeHubBackoffPolicyOption::Type>(
