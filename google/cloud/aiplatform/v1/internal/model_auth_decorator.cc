...
StatusOr<google::cloud::location::ListLocationsResponse> ModelServiceAuth::ListLocations(
    grpc::ClientContext& context,
    Options const& options,
...
StatusOr<google::iam::v1::TestIamPermissionsResponse> ModelServiceAuth::TestIamPermissions(
    grpc::ClientContext& context,
    Options const& options,
