...
CreateDefaultModelGardenServiceStub(
  ...
  std::shared_ptr<ModelGardenServiceStub> stub =
    std::make_shared<DefaultModelGardenServiceStub>(std::move(service_grpc_stub), std::move(service_operations_stub), std::move(service_iampolicy_stub), std::move(service_locations_stub));
