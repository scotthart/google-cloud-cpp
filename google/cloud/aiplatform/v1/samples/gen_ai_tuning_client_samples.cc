...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::aiplatform_v1::GenAiTuningServiceClient(
      google::cloud::aiplatform_v1::MakeGenAiTuningServiceConnection("unused", options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::aiplatform_v1::GenAiTuningServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::aiplatform_v1::GenAiTuningServiceConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::aiplatform_v1::GenAiTuningServiceConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::aiplatform_v1::GenAiTuningServiceRetryPolicyOption>(
      google::cloud::aiplatform_v1::GenAiTuningServiceLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::aiplatform_v1::GenAiTuningServiceBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::aiplatform_v1::MakeGenAiTuningServiceConnection("location-unused-in-this-example", options);
  ...
  auto c3 = google::cloud::aiplatform_v1::GenAiTuningServiceClient(
    connection, google::cloud::Options{}.set<google::cloud::aiplatform_v1::GenAiTuningServiceRetryPolicyOption>(
      google::cloud::aiplatform_v1::GenAiTuningServiceLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::aiplatform_v1::GenAiTuningServicePollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::aiplatform_v1::GenAiTuningServiceRetryPolicyOption::Type,
            google::cloud::aiplatform_v1::GenAiTuningServiceBackoffPolicyOption::Type>(
            google::cloud::aiplatform_v1::GenAiTuningServiceLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::aiplatform_v1::GenAiTuningServiceClient(
      google::cloud::aiplatform_v1::MakeGenAiTuningServiceConnection("us-west1" /* regional service region */, options));
  }
  //! [with-service-account]
  (argv.at(0));
}
