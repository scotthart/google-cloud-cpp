...
StatusOr<google::longrunning::Operation>
NotebookServiceClient::DeleteNotebookRuntime(google::cloud::ExperimentalTag,
...
StatusOr<google::longrunning::Operation>
NotebookServiceClient::UpgradeNotebookRuntime(google::cloud::ExperimentalTag,
                                              google::cloud::NoAwaitTag,
                                              std::string const& name,
                                              Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
...
StatusOr<google::longrunning::Operation>
NotebookServiceClient::StartNotebookRuntime(google::cloud::ExperimentalTag,
                                            google::cloud::NoAwaitTag,
                                            std::string const& name,
                                            Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
