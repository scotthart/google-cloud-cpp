...
class CustomIdempotencyPolicy
   : public google::cloud::securitycenter_v1::SecurityCenterConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::securitycenter_v1::SecurityCenterConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::securitycenter_v1::SecurityCenterConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::securitycenter_v1::SecurityCenterRetryPolicyOption>(
      google::cloud::securitycenter_v1::SecurityCenterLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::securitycenter_v1::SecurityCenterBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::securitycenter_v1::MakeSecurityCenterConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::securitycenter_v1::SecurityCenterClient(connection);
  auto c2 = google::cloud::securitycenter_v1::SecurityCenterClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::securitycenter_v1::SecurityCenterClient(
    connection, google::cloud::Options{}.set<google::cloud::securitycenter_v1::SecurityCenterRetryPolicyOption>(
      google::cloud::securitycenter_v1::SecurityCenterLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::securitycenter_v1::SecurityCenterRetryPolicyOption>(
  //       google::cloud::securitycenter_v1::SecurityCenterLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::securitycenter_v1::SecurityCenterPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::securitycenter_v1::SecurityCenterRetryPolicyOption::Type,
            google::cloud::securitycenter_v1::SecurityCenterBackoffPolicyOption::Type>(
            google::cloud::securitycenter_v1::SecurityCenterLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::securitycenter_v1::SecurityCenterClient(
      google::cloud::securitycenter_v1::MakeSecurityCenterConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
