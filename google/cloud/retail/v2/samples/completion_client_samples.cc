...
// clang-format off
// main-dox-marker: retail_v2::CompletionServiceClient
// lro-marker: true
// clang-format on
namespace {
...
class CustomIdempotencyPolicy
   : public google::cloud::retail_v2::CompletionServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::retail_v2::CompletionServiceConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::retail_v2::CompletionServiceConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::retail_v2::CompletionServiceRetryPolicyOption>(
      google::cloud::retail_v2::CompletionServiceLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::retail_v2::CompletionServiceBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::retail_v2::MakeCompletionServiceConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::retail_v2::CompletionServiceClient(connection);
  auto c2 = google::cloud::retail_v2::CompletionServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::retail_v2::CompletionServiceClient(
    connection, google::cloud::Options{}.set<google::cloud::retail_v2::CompletionServiceRetryPolicyOption>(
      google::cloud::retail_v2::CompletionServiceLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::retail_v2::CompletionServiceRetryPolicyOption>(
  //       google::cloud::retail_v2::CompletionServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::retail_v2::CompletionServicePollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::retail_v2::CompletionServiceRetryPolicyOption::Type,
            google::cloud::retail_v2::CompletionServiceBackoffPolicyOption::Type>(
            google::cloud::retail_v2::CompletionServiceLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::retail_v2::CompletionServiceClient(
      google::cloud::retail_v2::MakeCompletionServiceConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
