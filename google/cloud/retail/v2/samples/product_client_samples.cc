...
// clang-format off
// main-dox-marker: retail_v2::ProductServiceClient
// lro-marker: true
// clang-format on
namespace {
...
class CustomIdempotencyPolicy
   : public google::cloud::retail_v2::ProductServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::retail_v2::ProductServiceConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::retail_v2::ProductServiceConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::retail_v2::ProductServiceRetryPolicyOption>(
      google::cloud::retail_v2::ProductServiceLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::retail_v2::ProductServiceBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::retail_v2::MakeProductServiceConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::retail_v2::ProductServiceClient(connection);
  auto c2 = google::cloud::retail_v2::ProductServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::retail_v2::ProductServiceClient(
    connection, google::cloud::Options{}.set<google::cloud::retail_v2::ProductServiceRetryPolicyOption>(
      google::cloud::retail_v2::ProductServiceLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::retail_v2::ProductServiceRetryPolicyOption>(
  //       google::cloud::retail_v2::ProductServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::retail_v2::ProductServicePollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::retail_v2::ProductServiceRetryPolicyOption::Type,
            google::cloud::retail_v2::ProductServiceBackoffPolicyOption::Type>(
            google::cloud::retail_v2::ProductServiceLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::retail_v2::ProductServiceClient(
      google::cloud::retail_v2::MakeProductServiceConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
