...
// clang-format off
// main-dox-marker: retail_v2::UserEventServiceClient
// lro-marker: true
// clang-format on
namespace {
...
class CustomIdempotencyPolicy
   : public google::cloud::retail_v2::UserEventServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::retail_v2::UserEventServiceConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::retail_v2::UserEventServiceConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::retail_v2::UserEventServiceRetryPolicyOption>(
      google::cloud::retail_v2::UserEventServiceLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::retail_v2::UserEventServiceBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::retail_v2::MakeUserEventServiceConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::retail_v2::UserEventServiceClient(connection);
  auto c2 = google::cloud::retail_v2::UserEventServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::retail_v2::UserEventServiceClient(
    connection, google::cloud::Options{}.set<google::cloud::retail_v2::UserEventServiceRetryPolicyOption>(
      google::cloud::retail_v2::UserEventServiceLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::retail_v2::UserEventServiceRetryPolicyOption>(
  //       google::cloud::retail_v2::UserEventServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::retail_v2::UserEventServicePollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::retail_v2::UserEventServiceRetryPolicyOption::Type,
            google::cloud::retail_v2::UserEventServiceBackoffPolicyOption::Type>(
            google::cloud::retail_v2::UserEventServiceLimitedTimeRetryPolicy(
