...
class CompletionServiceClient {
 public:
  ...
  CompleteQuery(google::cloud::retail::v2::CompleteQueryRequest const& request, Options opts = {});
  ...
  ImportCompletionData(google::cloud::retail::v2::ImportCompletionDataRequest const& request, Options opts = {});
  ...
  ImportCompletionData(NoAwaitTag, google::cloud::retail::v2::ImportCompletionDataRequest const& request, Options opts = {});
  ...
  // clang-format on
  future<StatusOr<google::cloud::retail::v2::ImportCompletionDataResponse>>
  ImportCompletionData(google::longrunning::Operation const& operation, Options opts = {});
