...
#include "third_party/cloud_cpp/google/cloud/bigtable/internal/prefix_range_end.h"
...
class InstanceAdminEmulator final
    : public btadmin::grpc::BigtableInstanceAdmin::Service {
 public:
  ...
  grpc::Status CreateInstance(
    ...
    proto2::TextFormat::PrintToString(*request, &request_text);
...
class LongRunningEmulator final
    : public google::longrunning::grpc::Operations::Service {
 public:
