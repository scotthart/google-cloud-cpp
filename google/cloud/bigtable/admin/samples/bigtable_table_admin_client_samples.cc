...
class CustomIdempotencyPolicy
   : public google::cloud::bigtable_admin::BigtableTableAdminConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::bigtable_admin::BigtableTableAdminConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::bigtable_admin::BigtableTableAdminConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::bigtable_admin::BigtableTableAdminRetryPolicyOption>(
      google::cloud::bigtable_admin::BigtableTableAdminLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::bigtable_admin::BigtableTableAdminBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::bigtable_admin::MakeBigtableTableAdminConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::bigtable_admin::BigtableTableAdminClient(connection);
  auto c2 = google::cloud::bigtable_admin::BigtableTableAdminClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::bigtable_admin::BigtableTableAdminClient(
    connection, google::cloud::Options{}.set<google::cloud::bigtable_admin::BigtableTableAdminRetryPolicyOption>(
      google::cloud::bigtable_admin::BigtableTableAdminLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::bigtable_admin::BigtableTableAdminRetryPolicyOption>(
  //       google::cloud::bigtable_admin::BigtableTableAdminLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::bigtable_admin::BigtableTableAdminPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::bigtable_admin::BigtableTableAdminRetryPolicyOption::Type,
            google::cloud::bigtable_admin::BigtableTableAdminBackoffPolicyOption::Type>(
            google::cloud::bigtable_admin::BigtableTableAdminLimitedTimeRetryPolicy(
