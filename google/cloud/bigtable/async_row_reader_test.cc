...
#include "third_party/cloud_cpp/google/cloud/bigtable/testing/mock_data_client.h"
#include "third_party/cloud_cpp/google/cloud/bigtable/testing/mock_read_rows_reader.h"
...
TEST_F(TableAsyncReadRowsTest, DeepStack) {
  ...
  EXPECT_CALL(stream, Read(_, _))
      .WillOnce(Invoke([large_response](btproto::ReadRowsResponse* r, void*) {
        *r = large_response;
      }))
      .RetiresOnSaturation();
  EXPECT_CALL(stream, Finish(_, _))
