...
#include "third_party/cloud_cpp/google/cloud/bigtable/benchmarks/embedded_server.h"
#include "third_party/cloud_cpp/google/cloud/bigtable/benchmarks/random_mutation.h"
#include "third_party/cloud_cpp/google/cloud/bigtable/benchmarks/setup.h"
 ...
 */
class BigtableImpl final : public btproto::grpc::Bigtable::Service {
 public:
  BigtableImpl()
 ...
 * benchmarks.
 */
class TableAdminImpl final : public btadmin::grpc::BigtableTableAdmin::Service {
 public:
