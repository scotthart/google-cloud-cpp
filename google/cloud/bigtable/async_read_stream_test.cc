 ...
 */
class BulkApplyImpl final : public google::bigtable::v2::grpc::Bigtable::Service {
 public:
...
class AsyncReadStreamTest : public ::testing::Test {
 protected:
  void SetUp() override {
    ...
    stub_ = google::bigtable::v2::grpc::Bigtable::NewStub(channel);
  ...
  std::unique_ptr<google::bigtable::v2::grpc::Bigtable::StubInterface> stub_;
...
TEST_F(AsyncReadStreamTest, CannotConnect) {
  ...
  std::unique_ptr<google::bigtable::v2::grpc::Bigtable::StubInterface> stub =
      google::bigtable::v2::grpc::Bigtable::NewStub(channel);
