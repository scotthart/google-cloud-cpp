...
class InProcessDataClient : public bigtable::DataClient {
 public:
  ...
  using BigtableStubPtr =
      std::shared_ptr<google::bigtable::v2::grpc::Bigtable::StubInterface>;
  ...
  std::unique_ptr<google::bigtable::v2::grpc::Bigtable::Stub> Stub() {
    return google::bigtable::v2::grpc::Bigtable::NewStub(Channel());
  }
