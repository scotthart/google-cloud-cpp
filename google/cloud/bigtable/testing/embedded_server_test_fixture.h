...
#include "third_party/cloud_cpp/google/cloud/bigtable/testing/inprocess_admin_client.h"
#include "third_party/cloud_cpp/google/cloud/bigtable/testing/inprocess_data_client.h"
 ...
 */
class BigtableImpl final : public google::bigtable::v2::grpc::Bigtable::Service {
 public:
  BigtableImpl() {}
...
class TableAdminImpl final
    : public google::bigtable::admin::v2::grpc::BigtableTableAdmin::Service {
 public:
  TableAdminImpl() {}
