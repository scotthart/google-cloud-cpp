...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_IAP_V1_INTERNAL_IDENTITY_AWARE_PROXY_ADMIN_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_IAP_V1_INTERNAL_IDENTITY_AWARE_PROXY_ADMIN_LOGGING_DECORATOR_H
...
class IdentityAwareProxyAdminServiceLogging : public IdentityAwareProxyAdminServiceStub {
 public:
  ~IdentityAwareProxyAdminServiceLogging() override = default;
  IdentityAwareProxyAdminServiceLogging(std::shared_ptr<IdentityAwareProxyAdminServiceStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_IAP_V1_INTERNAL_IDENTITY_AWARE_PROXY_ADMIN_LOGGING_DECORATOR_H
