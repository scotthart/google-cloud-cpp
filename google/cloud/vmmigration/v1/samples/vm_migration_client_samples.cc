...
// clang-format off
// main-dox-marker: vmmigration_v1::VmMigrationClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::vmmigration_v1::VmMigrationClient(
...
class CustomIdempotencyPolicy
   : public google::cloud::vmmigration_v1::VmMigrationConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::vmmigration_v1::VmMigrationConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::vmmigration_v1::VmMigrationConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::vmmigration_v1::VmMigrationRetryPolicyOption>(
      google::cloud::vmmigration_v1::VmMigrationLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::vmmigration_v1::VmMigrationBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::vmmigration_v1::MakeVmMigrationConnection(options);
  ...
  auto c3 = google::cloud::vmmigration_v1::VmMigrationClient(
    connection, google::cloud::Options{}.set<google::cloud::vmmigration_v1::VmMigrationRetryPolicyOption>(
      google::cloud::vmmigration_v1::VmMigrationLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::vmmigration_v1::VmMigrationPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::vmmigration_v1::VmMigrationRetryPolicyOption::Type,
            google::cloud::vmmigration_v1::VmMigrationBackoffPolicyOption::Type>(
