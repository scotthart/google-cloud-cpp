...
// clang-format off
// main-dox-marker: dataplex_v1::DataTaxonomyServiceClient
// lro-marker: true
// clang-format on
namespace {
...
class CustomIdempotencyPolicy
   : public google::cloud::dataplex_v1::DataTaxonomyServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::dataplex_v1::DataTaxonomyServiceConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::dataplex_v1::DataTaxonomyServiceConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::dataplex_v1::DataTaxonomyServiceRetryPolicyOption>(
      google::cloud::dataplex_v1::DataTaxonomyServiceLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::dataplex_v1::DataTaxonomyServiceBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::dataplex_v1::MakeDataTaxonomyServiceConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::dataplex_v1::DataTaxonomyServiceClient(connection);
  auto c2 = google::cloud::dataplex_v1::DataTaxonomyServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::dataplex_v1::DataTaxonomyServiceClient(
    connection, google::cloud::Options{}.set<google::cloud::dataplex_v1::DataTaxonomyServiceRetryPolicyOption>(
      google::cloud::dataplex_v1::DataTaxonomyServiceLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::dataplex_v1::DataTaxonomyServiceRetryPolicyOption>(
  //       google::cloud::dataplex_v1::DataTaxonomyServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::dataplex_v1::DataTaxonomyServicePollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::dataplex_v1::DataTaxonomyServiceRetryPolicyOption::Type,
            google::cloud::dataplex_v1::DataTaxonomyServiceBackoffPolicyOption::Type>(
            google::cloud::dataplex_v1::DataTaxonomyServiceLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::dataplex_v1::DataTaxonomyServiceClient(
      google::cloud::dataplex_v1::MakeDataTaxonomyServiceConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
