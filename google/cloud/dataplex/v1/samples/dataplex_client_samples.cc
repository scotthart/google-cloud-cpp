...
class CustomIdempotencyPolicy
   : public google::cloud::dataplex_v1::DataplexServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::dataplex_v1::DataplexServiceConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::dataplex_v1::DataplexServiceConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::dataplex_v1::DataplexServiceRetryPolicyOption>(
      google::cloud::dataplex_v1::DataplexServiceLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::dataplex_v1::DataplexServiceBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::dataplex_v1::MakeDataplexServiceConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::dataplex_v1::DataplexServiceClient(connection);
  auto c2 = google::cloud::dataplex_v1::DataplexServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::dataplex_v1::DataplexServiceClient(
    connection, google::cloud::Options{}.set<google::cloud::dataplex_v1::DataplexServiceRetryPolicyOption>(
      google::cloud::dataplex_v1::DataplexServiceLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::dataplex_v1::DataplexServiceRetryPolicyOption>(
  //       google::cloud::dataplex_v1::DataplexServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::dataplex_v1::DataplexServicePollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::dataplex_v1::DataplexServiceRetryPolicyOption::Type,
            google::cloud::dataplex_v1::DataplexServiceBackoffPolicyOption::Type>(
            google::cloud::dataplex_v1::DataplexServiceLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::dataplex_v1::DataplexServiceClient(
      google::cloud::dataplex_v1::MakeDataplexServiceConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
