...
class PublisherClient {
 public:
  ...
  PublishChannelConnectionEvents(google::cloud::eventarc::publishing::v1::PublishChannelConnectionEventsRequest const& request, Options opts = {});
  ...
  PublishEvents(google::cloud::eventarc::publishing::v1::PublishEventsRequest const& request, Options opts = {});
  ...
  Publish(google::cloud::eventarc::publishing::v1::PublishRequest const& request, Options opts = {});
