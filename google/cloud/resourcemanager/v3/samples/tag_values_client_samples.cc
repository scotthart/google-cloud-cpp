...
// clang-format off
// main-dox-marker: resourcemanager_v3::TagValuesClient
// lro-marker: true
// clang-format on
namespace {
...
class CustomIdempotencyPolicy
   : public google::cloud::resourcemanager_v3::TagValuesConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::resourcemanager_v3::TagValuesConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::resourcemanager_v3::TagValuesConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::resourcemanager_v3::TagValuesRetryPolicyOption>(
      google::cloud::resourcemanager_v3::TagValuesLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::resourcemanager_v3::TagValuesBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::resourcemanager_v3::MakeTagValuesConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::resourcemanager_v3::TagValuesClient(connection);
  auto c2 = google::cloud::resourcemanager_v3::TagValuesClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::resourcemanager_v3::TagValuesClient(
    connection, google::cloud::Options{}.set<google::cloud::resourcemanager_v3::TagValuesRetryPolicyOption>(
      google::cloud::resourcemanager_v3::TagValuesLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::resourcemanager_v3::TagValuesRetryPolicyOption>(
  //       google::cloud::resourcemanager_v3::TagValuesLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::resourcemanager_v3::TagValuesPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::resourcemanager_v3::TagValuesRetryPolicyOption::Type,
            google::cloud::resourcemanager_v3::TagValuesBackoffPolicyOption::Type>(
            google::cloud::resourcemanager_v3::TagValuesLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::resourcemanager_v3::TagValuesClient(
      google::cloud::resourcemanager_v3::MakeTagValuesConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
