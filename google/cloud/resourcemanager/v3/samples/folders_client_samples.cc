...
class CustomIdempotencyPolicy
   : public google::cloud::resourcemanager_v3::FoldersConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::resourcemanager_v3::FoldersConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::resourcemanager_v3::FoldersConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::resourcemanager_v3::FoldersRetryPolicyOption>(
      google::cloud::resourcemanager_v3::FoldersLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::resourcemanager_v3::FoldersBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::resourcemanager_v3::MakeFoldersConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::resourcemanager_v3::FoldersClient(connection);
  auto c2 = google::cloud::resourcemanager_v3::FoldersClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::resourcemanager_v3::FoldersClient(
    connection, google::cloud::Options{}.set<google::cloud::resourcemanager_v3::FoldersRetryPolicyOption>(
      google::cloud::resourcemanager_v3::FoldersLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::resourcemanager_v3::FoldersRetryPolicyOption>(
  //       google::cloud::resourcemanager_v3::FoldersLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::resourcemanager_v3::FoldersPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::resourcemanager_v3::FoldersRetryPolicyOption::Type,
            google::cloud::resourcemanager_v3::FoldersBackoffPolicyOption::Type>(
            google::cloud::resourcemanager_v3::FoldersLimitedTimeRetryPolicy(
