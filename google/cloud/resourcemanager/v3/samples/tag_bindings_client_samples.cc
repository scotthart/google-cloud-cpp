...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::resourcemanager_v3::TagBindingsClient(
      google::cloud::resourcemanager_v3::MakeTagBindingsConnection(options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::resourcemanager_v3::TagBindingsConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::resourcemanager_v3::TagBindingsConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::resourcemanager_v3::TagBindingsConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::resourcemanager_v3::TagBindingsRetryPolicyOption>(
      google::cloud::resourcemanager_v3::TagBindingsLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::resourcemanager_v3::TagBindingsBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::resourcemanager_v3::MakeTagBindingsConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::resourcemanager_v3::TagBindingsClient(connection);
  auto c2 = google::cloud::resourcemanager_v3::TagBindingsClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::resourcemanager_v3::TagBindingsClient(
    connection, google::cloud::Options{}.set<google::cloud::resourcemanager_v3::TagBindingsRetryPolicyOption>(
      google::cloud::resourcemanager_v3::TagBindingsLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::resourcemanager_v3::TagBindingsRetryPolicyOption>(
  //       google::cloud::resourcemanager_v3::TagBindingsLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::resourcemanager_v3::TagBindingsPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::resourcemanager_v3::TagBindingsRetryPolicyOption::Type,
            google::cloud::resourcemanager_v3::TagBindingsBackoffPolicyOption::Type>(
            google::cloud::resourcemanager_v3::TagBindingsLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::resourcemanager_v3::TagBindingsClient(
      google::cloud::resourcemanager_v3::MakeTagBindingsConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
