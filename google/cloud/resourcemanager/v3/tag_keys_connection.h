...
class TagKeysRetryPolicy : public ::google::cloud::RetryPolicy {
 public:
  /// Creates a new instance of the policy, reset to the initial state.
  virtual std::unique_ptr<TagKeysRetryPolicy> clone() const = 0;
};
 ...
 */
class TagKeysLimitedErrorCountRetryPolicy : public TagKeysRetryPolicy {
 public:
  /**
  ...
  std::unique_ptr<TagKeysRetryPolicy> clone() const override {
    return std::make_unique<TagKeysLimitedErrorCountRetryPolicy>(
        maximum_failures());
  }
 ...
 * - [`kUnavailable`](@ref google::cloud::StatusCode)
 */
class TagKeysLimitedTimeRetryPolicy : public TagKeysRetryPolicy {
 public:
  /**
 ...
 * sets in `TagKeysClient`. This allows users to inject custom behavior
 * (e.g., with a Google Mock object) when writing tests that use objects of type
 * `TagKeysClient`.
 *
 * To create a concrete instance, see `MakeTagKeysConnection()`.
 *
 * For mocking, see `resourcemanager_v3_mocks::MockTagKeysConnection`.
 */
class TagKeysConnection {
 public:
  virtual ~TagKeysConnection() = 0;
 ...
 * should be passed as an argument to the constructor of TagKeysClient.
 *
 * The optional @p options argument may be used to configure aspects of the
 * returned `TagKeysConnection`. Expected options are any of the types in
 * the following option lists:
 *
 * - `google::cloud::CommonOptionList`
 * - `google::cloud::GrpcOptionList`
 * - `google::cloud::UnifiedCredentialsOptionList`
 * - `google::cloud::resourcemanager_v3::TagKeysPolicyOptionList`
 *
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_RESOURCEMANAGER_V3_TAG_KEYS_CONNECTION_H
