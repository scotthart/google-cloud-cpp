...
// clang-format off
// main-dox-marker: migrationcenter_v1::MigrationCenterClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::migrationcenter_v1::MigrationCenterClient(
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  //     .set<google::cloud::migrationcenter_v1::MigrationCenterRetryPolicyOption>(
  //       google::cloud::migrationcenter_v1::MigrationCenterLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
