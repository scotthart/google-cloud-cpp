...
// clang-format off
// main-dox-marker: kms_v1::AutokeyClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::kms_v1::AutokeyClient(
      google::cloud::kms_v1::MakeAutokeyConnection(options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::kms_v1::AutokeyConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::kms_v1::AutokeyConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::kms_v1::AutokeyConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::kms_v1::AutokeyRetryPolicyOption>(
      google::cloud::kms_v1::AutokeyLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::kms_v1::AutokeyBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::kms_v1::MakeAutokeyConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::kms_v1::AutokeyClient(connection);
  auto c2 = google::cloud::kms_v1::AutokeyClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::kms_v1::AutokeyClient(
    connection, google::cloud::Options{}.set<google::cloud::kms_v1::AutokeyRetryPolicyOption>(
      google::cloud::kms_v1::AutokeyLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::kms_v1::AutokeyRetryPolicyOption>(
  //       google::cloud::kms_v1::AutokeyLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::kms_v1::AutokeyPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::kms_v1::AutokeyRetryPolicyOption::Type,
            google::cloud::kms_v1::AutokeyBackoffPolicyOption::Type>(
            google::cloud::kms_v1::AutokeyLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::kms_v1::AutokeyClient(
      google::cloud::kms_v1::MakeAutokeyConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
