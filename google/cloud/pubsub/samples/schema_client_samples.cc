...
// clang-format off
// main-dox-marker: pubsub::SchemaServiceClient
// clang-format on
namespace {
...
class CustomIdempotencyPolicy
   : public google::cloud::pubsub::SchemaServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::pubsub::SchemaServiceConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::pubsub::SchemaServiceConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::pubsub::SchemaServiceRetryPolicyOption>(
      google::cloud::pubsub::SchemaServiceLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::pubsub::SchemaServiceBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::pubsub::MakeSchemaServiceConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::pubsub::SchemaServiceClient(connection);
  auto c2 = google::cloud::pubsub::SchemaServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::pubsub::SchemaServiceClient(
    connection, google::cloud::Options{}.set<google::cloud::pubsub::SchemaServiceRetryPolicyOption>(
      google::cloud::pubsub::SchemaServiceLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::pubsub::SchemaServiceClient(
      google::cloud::pubsub::MakeSchemaServiceConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
