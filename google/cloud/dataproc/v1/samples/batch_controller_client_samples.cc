...
// clang-format off
// main-dox-marker: dataproc_v1::BatchControllerClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::dataproc_v1::BatchControllerClient(
      google::cloud::dataproc_v1::MakeBatchControllerConnection(options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::dataproc_v1::BatchControllerConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::dataproc_v1::BatchControllerConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::dataproc_v1::BatchControllerConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::dataproc_v1::BatchControllerRetryPolicyOption>(
      google::cloud::dataproc_v1::BatchControllerLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::dataproc_v1::BatchControllerBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::dataproc_v1::MakeBatchControllerConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::dataproc_v1::BatchControllerClient(connection);
  auto c2 = google::cloud::dataproc_v1::BatchControllerClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::dataproc_v1::BatchControllerClient(
    connection, google::cloud::Options{}.set<google::cloud::dataproc_v1::BatchControllerRetryPolicyOption>(
      google::cloud::dataproc_v1::BatchControllerLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::dataproc_v1::BatchControllerRetryPolicyOption>(
  //       google::cloud::dataproc_v1::BatchControllerLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::dataproc_v1::BatchControllerPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::dataproc_v1::BatchControllerRetryPolicyOption::Type,
            google::cloud::dataproc_v1::BatchControllerBackoffPolicyOption::Type>(
            google::cloud::dataproc_v1::BatchControllerLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::dataproc_v1::BatchControllerClient(
      google::cloud::dataproc_v1::MakeBatchControllerConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
