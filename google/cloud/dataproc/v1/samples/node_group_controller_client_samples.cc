...
// clang-format off
// main-dox-marker: dataproc_v1::NodeGroupControllerClient
// lro-marker: true
// clang-format on
namespace {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto c2 = google::cloud::dataproc_v1::NodeGroupControllerClient(connection);
  ...
  //     .set<google::cloud::dataproc_v1::NodeGroupControllerRetryPolicyOption>(
  //       google::cloud::dataproc_v1::NodeGroupControllerLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::dataproc_v1::NodeGroupControllerPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::dataproc_v1::NodeGroupControllerRetryPolicyOption::Type,
            google::cloud::dataproc_v1::NodeGroupControllerBackoffPolicyOption::Type>(
            google::cloud::dataproc_v1::NodeGroupControllerLimitedTimeRetryPolicy(
