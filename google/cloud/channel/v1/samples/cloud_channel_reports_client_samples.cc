...
// clang-format off
// main-dox-marker: channel_v1::CloudChannelReportsServiceClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::channel_v1::CloudChannelReportsServiceClient(
      google::cloud::channel_v1::MakeCloudChannelReportsServiceConnection(options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::channel_v1::CloudChannelReportsServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::channel_v1::CloudChannelReportsServiceConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::channel_v1::CloudChannelReportsServiceConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::channel_v1::CloudChannelReportsServiceRetryPolicyOption>(
      google::cloud::channel_v1::CloudChannelReportsServiceLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::channel_v1::CloudChannelReportsServiceBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::channel_v1::MakeCloudChannelReportsServiceConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::channel_v1::CloudChannelReportsServiceClient(connection);
  auto c2 = google::cloud::channel_v1::CloudChannelReportsServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::channel_v1::CloudChannelReportsServiceClient(
    connection, google::cloud::Options{}.set<google::cloud::channel_v1::CloudChannelReportsServiceRetryPolicyOption>(
      google::cloud::channel_v1::CloudChannelReportsServiceLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::channel_v1::CloudChannelReportsServicePollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::channel_v1::CloudChannelReportsServiceRetryPolicyOption::Type,
            google::cloud::channel_v1::CloudChannelReportsServiceBackoffPolicyOption::Type>(
            google::cloud::channel_v1::CloudChannelReportsServiceLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::channel_v1::CloudChannelReportsServiceClient(
      google::cloud::channel_v1::MakeCloudChannelReportsServiceConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
