...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_INSTANCE_TEMPLATES_V1_MOCKS_MOCK_INSTANCE_TEMPLATES_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_INSTANCE_TEMPLATES_V1_MOCKS_MOCK_INSTANCE_TEMPLATES_CONNECTION_H
...
namespace google {
namespace cloud {
namespace compute_instance_templates_v1_mocks {
...
class MockInstanceTemplatesConnection
 ...
 public:
  ...
  MOCK_METHOD(StatusOr<google::cloud::cpp::compute::v1::Operation>,
              StartDeleteInstanceTemplate,
              (google::cloud::cpp::compute::instance_templates::v1::
                   DeleteInstanceTemplateRequest const& request),
              (override));

  MOCK_METHOD(future<StatusOr<google::cloud::cpp::compute::v1::Operation>>,
              AwaitDeleteInstanceTemplate,
  ...
  MOCK_METHOD(StatusOr<google::cloud::cpp::compute::v1::Operation>,
              StartInsertInstanceTemplate,
              (google::cloud::cpp::compute::instance_templates::v1::
                   InsertInstanceTemplateRequest const& request),
              (override));

  MOCK_METHOD(future<StatusOr<google::cloud::cpp::compute::v1::Operation>>,
              AwaitInsertInstanceTemplate,
              (google::cloud::cpp::compute::v1::Operation const& operation),
              (override));
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_INSTANCE_TEMPLATES_V1_MOCKS_MOCK_INSTANCE_TEMPLATES_CONNECTION_H
