...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::compute_interconnects_v1::InterconnectsClient(
      google::cloud::compute_interconnects_v1::MakeInterconnectsConnectionRest(options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::compute_interconnects_v1::InterconnectsConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::compute_interconnects_v1::InterconnectsConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::compute_interconnects_v1::InterconnectsConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::compute_interconnects_v1::InterconnectsRetryPolicyOption>(
      google::cloud::compute_interconnects_v1::InterconnectsLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::compute_interconnects_v1::InterconnectsBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::compute_interconnects_v1::MakeInterconnectsConnectionRest(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::compute_interconnects_v1::InterconnectsClient(connection);
  auto c2 = google::cloud::compute_interconnects_v1::InterconnectsClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::compute_interconnects_v1::InterconnectsClient(
    connection, google::cloud::Options{}.set<google::cloud::compute_interconnects_v1::InterconnectsRetryPolicyOption>(
      google::cloud::compute_interconnects_v1::InterconnectsLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::compute_interconnects_v1::InterconnectsRetryPolicyOption>(
  //       google::cloud::compute_interconnects_v1::InterconnectsLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::compute_interconnects_v1::InterconnectsPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::compute_interconnects_v1::InterconnectsRetryPolicyOption::Type,
            google::cloud::compute_interconnects_v1::InterconnectsBackoffPolicyOption::Type>(
            google::cloud::compute_interconnects_v1::InterconnectsLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::compute_interconnects_v1::InterconnectsClient(
      google::cloud::compute_interconnects_v1::MakeInterconnectsConnectionRest(options));
  }
  //! [with-service-account]
  (argv.at(0));
