...
CreateDefaultServiceAttachmentsRestStub(Options& options) {
  Options stub_creation_opts = rest_internal::DetermineStubCreationOptions(
      internal::GetEnv("GOOGLE_CLOUD_CPP_SERVICE_ATTACHMENTS_ENDPOINT"),
      "compute.googleapis.com", options);

  std::shared_ptr<ServiceAttachmentsRestStub> stub =
      std::make_shared<DefaultServiceAttachmentsRestStub>(
