...
#include "google/cloud/compute/instance_settings/v1/internal/instance_settings_rest_connection_impl.h"
...
InstanceSettingsRestConnectionImpl::InstanceSettingsRestConnectionImpl(
    ...
    : background_(std::move(background)),
      ...
      options_(internal::MergeOptions(std::move(options),
                                      InstanceSettingsConnection::options())) {}

StatusOr<google::cloud::cpp::compute::v1::InstanceSettings>
InstanceSettingsRestConnectionImpl::GetInstanceSettings(
    google::cloud::cpp::compute::instance_settings::v1::
        GetInstanceSettingsRequest const& request) {
  auto current = google::cloud::internal::SaveCurrentOptions();
  return google::cloud::rest_internal::RestRetryLoop(
      retry_policy(*current), backoff_policy(*current),
      idempotency_policy(*current)->GetInstanceSettings(request),
      [this](rest_internal::RestContext& rest_context, Options const& options,
             google::cloud::cpp::compute::instance_settings::v1::
                 GetInstanceSettingsRequest const& request) {
        return stub_->GetInstanceSettings(rest_context, options, request);
      },
...
InstanceSettingsRestConnectionImpl::PatchInstanceSettings(
  ...
  return rest_internal::AsyncRestLongRunningOperation<
      ...
      [stub = stub_](CompletionQueue& cq,
                     ...
                     google::cloud::cpp::compute::instance_settings::v1::
                         PatchInstanceSettingsRequest const& request) {
        return stub->AsyncPatchInstanceSettings(cq, std::move(context),
      ...
      retry_policy(*current), backoff_policy(*current),
      idempotency_policy(*current)->PatchInstanceSettings(request),
...
InstanceSettingsRestConnectionImpl::PatchInstanceSettings(
  ...
  return google::cloud::rest_internal::RestRetryLoop(
      ...
      [this](rest_internal::RestContext& rest_context, Options const& options,
             google::cloud::cpp::compute::instance_settings::v1::
                 PatchInstanceSettingsRequest const& request) {
        return stub_->PatchInstanceSettings(rest_context, options, request);
      },
      *current, request, __func__);
}
