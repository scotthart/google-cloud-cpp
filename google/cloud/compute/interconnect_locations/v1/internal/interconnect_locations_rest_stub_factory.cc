...
CreateDefaultInterconnectLocationsRestStub(Options& options) {
  Options stub_creation_opts = rest_internal::DetermineStubCreationOptions(
      internal::GetEnv("GOOGLE_CLOUD_CPP_INTERCONNECT_LOCATIONS_ENDPOINT"),
      "compute.googleapis.com", options);

  std::shared_ptr<InterconnectLocationsRestStub> stub =
      std::make_shared<DefaultInterconnectLocationsRestStub>(
