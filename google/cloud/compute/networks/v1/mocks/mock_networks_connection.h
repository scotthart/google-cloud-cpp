...
class MockNetworksConnection : public compute_networks_v1::NetworksConnection {
 public:
  ...
  MOCK_METHOD(
      StatusOr<google::cloud::cpp::compute::v1::Operation>, StartAddPeering,
      (google::cloud::cpp::compute::networks::v1::AddPeeringRequest const&
           request),
      (override));
  ...
  MOCK_METHOD(
      StatusOr<google::cloud::cpp::compute::v1::Operation>, StartDeleteNetwork,
      (google::cloud::cpp::compute::networks::v1::DeleteNetworkRequest const&
           request),
      (override));
  ...
  MOCK_METHOD(
      StatusOr<google::cloud::cpp::compute::v1::Operation>, StartInsertNetwork,
      (google::cloud::cpp::compute::networks::v1::InsertNetworkRequest const&
           request),
      (override));
  ...
  MOCK_METHOD(
      StatusOr<google::cloud::cpp::compute::v1::Operation>, StartPatchNetwork,
      (google::cloud::cpp::compute::networks::v1::PatchNetworkRequest const&
           request),
      (override));
  ...
  MOCK_METHOD(
      StatusOr<google::cloud::cpp::compute::v1::Operation>, StartRemovePeering,
      (google::cloud::cpp::compute::networks::v1::RemovePeeringRequest const&
           request),
      (override));
  ...
  MOCK_METHOD(StatusOr<google::cloud::cpp::compute::v1::Operation>,
              StartSwitchToCustomMode,
              (google::cloud::cpp::compute::networks::v1::
                   SwitchToCustomModeRequest const& request),
              (override));

  MOCK_METHOD(future<StatusOr<google::cloud::cpp::compute::v1::Operation>>,
              AwaitSwitchToCustomMode,
              (google::cloud::cpp::compute::v1::Operation const& operation),
              (override));
  ...
  MOCK_METHOD(
      StatusOr<google::cloud::cpp::compute::v1::Operation>, StartUpdatePeering,
      (google::cloud::cpp::compute::networks::v1::UpdatePeeringRequest const&
           request),
      (override));
