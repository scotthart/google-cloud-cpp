...
// clang-format off
// main-dox-marker: compute_networks_v1::NetworksClient
// lro-marker: true
// clang-format on
namespace {
...
class CustomIdempotencyPolicy
   : public google::cloud::compute_networks_v1::NetworksConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::compute_networks_v1::NetworksConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::compute_networks_v1::NetworksConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::compute_networks_v1::NetworksRetryPolicyOption>(
      google::cloud::compute_networks_v1::NetworksLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::compute_networks_v1::NetworksBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::compute_networks_v1::MakeNetworksConnectionRest(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::compute_networks_v1::NetworksClient(connection);
  auto c2 = google::cloud::compute_networks_v1::NetworksClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::compute_networks_v1::NetworksClient(
    connection, google::cloud::Options{}.set<google::cloud::compute_networks_v1::NetworksRetryPolicyOption>(
      google::cloud::compute_networks_v1::NetworksLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::compute_networks_v1::NetworksRetryPolicyOption>(
  //       google::cloud::compute_networks_v1::NetworksLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::compute_networks_v1::NetworksPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::compute_networks_v1::NetworksRetryPolicyOption::Type,
            google::cloud::compute_networks_v1::NetworksBackoffPolicyOption::Type>(
            google::cloud::compute_networks_v1::NetworksLimitedTimeRetryPolicy(
