...
std::shared_ptr<RegionInstanceGroupManagersRestStub>
CreateDefaultRegionInstanceGroupManagersRestStub(Options& options) {
  ...
  std::shared_ptr<RegionInstanceGroupManagersRestStub> stub =
      std::make_shared<DefaultRegionInstanceGroupManagersRestStub>(
          std::move(stub_creation_opts));
  stub = std::make_shared<RegionInstanceGroupManagersRestMetadata>(
      std::move(stub));
  if (internal::Contains(options.get<TracingComponentsOption>(), "rpc")) {
    GCP_LOG(INFO) << "Enabled logging for REST rpc calls";
    stub = std::make_shared<RegionInstanceGroupManagersRestLogging>(
