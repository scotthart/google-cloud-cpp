...
Idempotency RegionInstanceGroupManagersConnectionIdempotencyPolicy::DeleteInstanceGroupManager(google::cloud::cpp::compute::region_instance_group_managers::v1::DeleteInstanceGroupManagerRequest const&) {
  return Idempotency::kNonIdempotent;
}
...
Idempotency RegionInstanceGroupManagersConnectionIdempotencyPolicy::GetInstanceGroupManager(google::cloud::cpp::compute::region_instance_group_managers::v1::GetInstanceGroupManagerRequest const&) {
  return Idempotency::kIdempotent;
}

Idempotency RegionInstanceGroupManagersConnectionIdempotencyPolicy::InsertInstanceGroupManager(google::cloud::cpp::compute::region_instance_group_managers::v1::InsertInstanceGroupManagerRequest const&) {
  return Idempotency::kNonIdempotent;
}
...
Idempotency RegionInstanceGroupManagersConnectionIdempotencyPolicy::PatchInstanceGroupManager(google::cloud::cpp::compute::region_instance_group_managers::v1::PatchInstanceGroupManagerRequest const&) {
  return Idempotency::kNonIdempotent;
}
