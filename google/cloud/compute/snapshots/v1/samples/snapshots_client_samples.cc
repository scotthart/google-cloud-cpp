...
// clang-format off
// main-dox-marker: compute_snapshots_v1::SnapshotsClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::compute_snapshots_v1::SnapshotsClient(
      google::cloud::compute_snapshots_v1::MakeSnapshotsConnectionRest(options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::compute_snapshots_v1::SnapshotsConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::compute_snapshots_v1::SnapshotsConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::compute_snapshots_v1::SnapshotsConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::compute_snapshots_v1::SnapshotsRetryPolicyOption>(
      google::cloud::compute_snapshots_v1::SnapshotsLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::compute_snapshots_v1::SnapshotsBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::compute_snapshots_v1::MakeSnapshotsConnectionRest(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::compute_snapshots_v1::SnapshotsClient(connection);
  auto c2 = google::cloud::compute_snapshots_v1::SnapshotsClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::compute_snapshots_v1::SnapshotsClient(
    connection, google::cloud::Options{}.set<google::cloud::compute_snapshots_v1::SnapshotsRetryPolicyOption>(
      google::cloud::compute_snapshots_v1::SnapshotsLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::compute_snapshots_v1::SnapshotsRetryPolicyOption>(
  //       google::cloud::compute_snapshots_v1::SnapshotsLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::compute_snapshots_v1::SnapshotsPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::compute_snapshots_v1::SnapshotsRetryPolicyOption::Type,
            google::cloud::compute_snapshots_v1::SnapshotsBackoffPolicyOption::Type>(
            google::cloud::compute_snapshots_v1::SnapshotsLimitedTimeRetryPolicy(
