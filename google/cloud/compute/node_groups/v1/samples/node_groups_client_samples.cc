...
// clang-format off
// main-dox-marker: compute_node_groups_v1::NodeGroupsClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::compute_node_groups_v1::NodeGroupsClient(
      google::cloud::compute_node_groups_v1::MakeNodeGroupsConnectionRest(options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::compute_node_groups_v1::NodeGroupsConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::compute_node_groups_v1::NodeGroupsConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::compute_node_groups_v1::NodeGroupsConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::compute_node_groups_v1::NodeGroupsRetryPolicyOption>(
      google::cloud::compute_node_groups_v1::NodeGroupsLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::compute_node_groups_v1::NodeGroupsBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::compute_node_groups_v1::MakeNodeGroupsConnectionRest(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::compute_node_groups_v1::NodeGroupsClient(connection);
  auto c2 = google::cloud::compute_node_groups_v1::NodeGroupsClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::compute_node_groups_v1::NodeGroupsClient(
    connection, google::cloud::Options{}.set<google::cloud::compute_node_groups_v1::NodeGroupsRetryPolicyOption>(
      google::cloud::compute_node_groups_v1::NodeGroupsLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::compute_node_groups_v1::NodeGroupsRetryPolicyOption>(
  //       google::cloud::compute_node_groups_v1::NodeGroupsLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::compute_node_groups_v1::NodeGroupsPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::compute_node_groups_v1::NodeGroupsRetryPolicyOption::Type,
            google::cloud::compute_node_groups_v1::NodeGroupsBackoffPolicyOption::Type>(
            google::cloud::compute_node_groups_v1::NodeGroupsLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::compute_node_groups_v1::NodeGroupsClient(
      google::cloud::compute_node_groups_v1::MakeNodeGroupsConnectionRest(options));
  }
  //! [with-service-account]
  (argv.at(0));
