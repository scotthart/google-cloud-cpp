...
// clang-format off
// main-dox-marker: compute_ssl_policies_v1::SslPoliciesClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::compute_ssl_policies_v1::SslPoliciesClient(
      google::cloud::compute_ssl_policies_v1::MakeSslPoliciesConnectionRest(options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::compute_ssl_policies_v1::SslPoliciesConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::compute_ssl_policies_v1::SslPoliciesConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::compute_ssl_policies_v1::SslPoliciesConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::compute_ssl_policies_v1::SslPoliciesRetryPolicyOption>(
      google::cloud::compute_ssl_policies_v1::SslPoliciesLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::compute_ssl_policies_v1::SslPoliciesBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::compute_ssl_policies_v1::MakeSslPoliciesConnectionRest(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::compute_ssl_policies_v1::SslPoliciesClient(connection);
  auto c2 = google::cloud::compute_ssl_policies_v1::SslPoliciesClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::compute_ssl_policies_v1::SslPoliciesClient(
    connection, google::cloud::Options{}.set<google::cloud::compute_ssl_policies_v1::SslPoliciesRetryPolicyOption>(
      google::cloud::compute_ssl_policies_v1::SslPoliciesLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::compute_ssl_policies_v1::SslPoliciesPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::compute_ssl_policies_v1::SslPoliciesRetryPolicyOption::Type,
            google::cloud::compute_ssl_policies_v1::SslPoliciesBackoffPolicyOption::Type>(
            google::cloud::compute_ssl_policies_v1::SslPoliciesLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::compute_ssl_policies_v1::SslPoliciesClient(
      google::cloud::compute_ssl_policies_v1::MakeSslPoliciesConnectionRest(options));
  }
  //! [with-service-account]
  (argv.at(0));
