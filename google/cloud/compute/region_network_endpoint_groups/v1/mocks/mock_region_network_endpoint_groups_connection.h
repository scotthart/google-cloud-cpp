...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_REGION_NETWORK_ENDPOINT_GROUPS_V1_MOCKS_MOCK_REGION_NETWORK_ENDPOINT_GROUPS_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_REGION_NETWORK_ENDPOINT_GROUPS_V1_MOCKS_MOCK_REGION_NETWORK_ENDPOINT_GROUPS_CONNECTION_H
...
namespace google {
namespace cloud {
namespace compute_region_network_endpoint_groups_v1_mocks {
GOOGLE_CLOUD_CPP_INLINE_NAMESPACE_BEGIN

/**
 * A class to mock `RegionNetworkEndpointGroupsConnection`.
 *
 * Application developers may want to test their code with simulated responses,
 * including errors, from an object of type `RegionNetworkEndpointGroupsClient`.
 * To do so, construct an object of type `RegionNetworkEndpointGroupsClient`
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_REGION_NETWORK_ENDPOINT_GROUPS_V1_MOCKS_MOCK_REGION_NETWORK_ENDPOINT_GROUPS_CONNECTION_H
