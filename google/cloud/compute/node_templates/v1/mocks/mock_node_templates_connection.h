...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_NODE_TEMPLATES_V1_MOCKS_MOCK_NODE_TEMPLATES_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_NODE_TEMPLATES_V1_MOCKS_MOCK_NODE_TEMPLATES_CONNECTION_H
...
namespace google {
namespace cloud {
namespace compute_node_templates_v1_mocks {
GOOGLE_CLOUD_CPP_INLINE_NAMESPACE_BEGIN

/**
 * A class to mock `NodeTemplatesConnection`.
 *
 * Application developers may want to test their code with simulated responses,
 * including errors, from an object of type `NodeTemplatesClient`. To do so,
 * construct an object of type `NodeTemplatesClient` with an instance of this
...
class MockNodeTemplatesConnection
 ...
 public:
  ...
  MOCK_METHOD(StatusOr<google::cloud::cpp::compute::v1::Operation>,
              StartDeleteNodeTemplate,
              (google::cloud::cpp::compute::node_templates::v1::
                   DeleteNodeTemplateRequest const& request),
              (override));

  MOCK_METHOD(future<StatusOr<google::cloud::cpp::compute::v1::Operation>>,
              AwaitDeleteNodeTemplate,
  ...
  MOCK_METHOD(StatusOr<google::cloud::cpp::compute::v1::Operation>,
              StartInsertNodeTemplate,
              (google::cloud::cpp::compute::node_templates::v1::
                   InsertNodeTemplateRequest const& request),
              (override));

  MOCK_METHOD(future<StatusOr<google::cloud::cpp::compute::v1::Operation>>,
              AwaitInsertNodeTemplate,
              (google::cloud::cpp::compute::v1::Operation const& operation),
              (override));
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_NODE_TEMPLATES_V1_MOCKS_MOCK_NODE_TEMPLATES_CONNECTION_H
