...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::compute_vpn_tunnels_v1::VpnTunnelsClient(
      google::cloud::compute_vpn_tunnels_v1::MakeVpnTunnelsConnectionRest(options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::compute_vpn_tunnels_v1::VpnTunnelsConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::compute_vpn_tunnels_v1::VpnTunnelsConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::compute_vpn_tunnels_v1::VpnTunnelsConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::compute_vpn_tunnels_v1::VpnTunnelsRetryPolicyOption>(
      google::cloud::compute_vpn_tunnels_v1::VpnTunnelsLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::compute_vpn_tunnels_v1::VpnTunnelsBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::compute_vpn_tunnels_v1::MakeVpnTunnelsConnectionRest(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::compute_vpn_tunnels_v1::VpnTunnelsClient(connection);
  auto c2 = google::cloud::compute_vpn_tunnels_v1::VpnTunnelsClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::compute_vpn_tunnels_v1::VpnTunnelsClient(
    connection, google::cloud::Options{}.set<google::cloud::compute_vpn_tunnels_v1::VpnTunnelsRetryPolicyOption>(
      google::cloud::compute_vpn_tunnels_v1::VpnTunnelsLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::compute_vpn_tunnels_v1::VpnTunnelsRetryPolicyOption>(
  //       google::cloud::compute_vpn_tunnels_v1::VpnTunnelsLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::compute_vpn_tunnels_v1::VpnTunnelsPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::compute_vpn_tunnels_v1::VpnTunnelsRetryPolicyOption::Type,
            google::cloud::compute_vpn_tunnels_v1::VpnTunnelsBackoffPolicyOption::Type>(
            google::cloud::compute_vpn_tunnels_v1::VpnTunnelsLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::compute_vpn_tunnels_v1::VpnTunnelsClient(
      google::cloud::compute_vpn_tunnels_v1::MakeVpnTunnelsConnectionRest(options));
  }
  //! [with-service-account]
  (argv.at(0));
