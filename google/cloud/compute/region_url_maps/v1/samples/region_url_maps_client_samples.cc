...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::compute_region_url_maps_v1::RegionUrlMapsClient(
      google::cloud::compute_region_url_maps_v1::MakeRegionUrlMapsConnectionRest(options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::compute_region_url_maps_v1::RegionUrlMapsConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::compute_region_url_maps_v1::RegionUrlMapsConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::compute_region_url_maps_v1::RegionUrlMapsConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::compute_region_url_maps_v1::RegionUrlMapsRetryPolicyOption>(
      google::cloud::compute_region_url_maps_v1::RegionUrlMapsLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::compute_region_url_maps_v1::RegionUrlMapsBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::compute_region_url_maps_v1::MakeRegionUrlMapsConnectionRest(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::compute_region_url_maps_v1::RegionUrlMapsClient(connection);
  auto c2 = google::cloud::compute_region_url_maps_v1::RegionUrlMapsClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::compute_region_url_maps_v1::RegionUrlMapsClient(
    connection, google::cloud::Options{}.set<google::cloud::compute_region_url_maps_v1::RegionUrlMapsRetryPolicyOption>(
      google::cloud::compute_region_url_maps_v1::RegionUrlMapsLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::compute_region_url_maps_v1::RegionUrlMapsPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::compute_region_url_maps_v1::RegionUrlMapsRetryPolicyOption::Type,
            google::cloud::compute_region_url_maps_v1::RegionUrlMapsBackoffPolicyOption::Type>(
            google::cloud::compute_region_url_maps_v1::RegionUrlMapsLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::compute_region_url_maps_v1::RegionUrlMapsClient(
      google::cloud::compute_region_url_maps_v1::MakeRegionUrlMapsConnectionRest(options));
  }
  //! [with-service-account]
  (argv.at(0));
