...
// clang-format off
// main-dox-marker: compute_instance_group_managers_v1::InstanceGroupManagersClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::compute_instance_group_managers_v1::InstanceGroupManagersClient(
      google::cloud::compute_instance_group_managers_v1::MakeInstanceGroupManagersConnectionRest(options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::compute_instance_group_managers_v1::InstanceGroupManagersConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::compute_instance_group_managers_v1::InstanceGroupManagersConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::compute_instance_group_managers_v1::InstanceGroupManagersConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::compute_instance_group_managers_v1::InstanceGroupManagersRetryPolicyOption>(
      google::cloud::compute_instance_group_managers_v1::InstanceGroupManagersLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::compute_instance_group_managers_v1::InstanceGroupManagersBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::compute_instance_group_managers_v1::MakeInstanceGroupManagersConnectionRest(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::compute_instance_group_managers_v1::InstanceGroupManagersClient(connection);
  auto c2 = google::cloud::compute_instance_group_managers_v1::InstanceGroupManagersClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::compute_instance_group_managers_v1::InstanceGroupManagersClient(
    connection, google::cloud::Options{}.set<google::cloud::compute_instance_group_managers_v1::InstanceGroupManagersRetryPolicyOption>(
      google::cloud::compute_instance_group_managers_v1::InstanceGroupManagersLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::compute_instance_group_managers_v1::InstanceGroupManagersPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::compute_instance_group_managers_v1::InstanceGroupManagersRetryPolicyOption::Type,
            google::cloud::compute_instance_group_managers_v1::InstanceGroupManagersBackoffPolicyOption::Type>(
            google::cloud::compute_instance_group_managers_v1::InstanceGroupManagersLimitedTimeRetryPolicy(
