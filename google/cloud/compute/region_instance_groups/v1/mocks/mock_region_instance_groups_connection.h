...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_REGION_INSTANCE_GROUPS_V1_MOCKS_MOCK_REGION_INSTANCE_GROUPS_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_REGION_INSTANCE_GROUPS_V1_MOCKS_MOCK_REGION_INSTANCE_GROUPS_CONNECTION_H
...
namespace google {
namespace cloud {
namespace compute_region_instance_groups_v1_mocks {
GOOGLE_CLOUD_CPP_INLINE_NAMESPACE_BEGIN

/**
 * A class to mock `RegionInstanceGroupsConnection`.
 *
 * Application developers may want to test their code with simulated responses,
 * including errors, from an object of type `RegionInstanceGroupsClient`. To do
 * so, construct an object of type `RegionInstanceGroupsClient` with an instance
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_COMPUTE_REGION_INSTANCE_GROUPS_V1_MOCKS_MOCK_REGION_INSTANCE_GROUPS_CONNECTION_H
