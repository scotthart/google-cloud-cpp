...
#include "third_party/cloud_cpp/google/cloud/optional.h"
...
#include "third_party/cloud_cpp/google/cloud/storage/internal/sha256_hash.h"
...
class ServiceAccountCredentials : public Credentials {
 ...
 private:
   ...
   */
  std::string MakeJWTAssertion(nlohmann::json const& header,
