...
#include "third_party/cloud_cpp/google/cloud/internal/getenv.h"
#include "third_party/cloud_cpp/google/cloud/status.h"
#include "third_party/cloud_cpp/google/cloud/storage/internal/compute_engine_util.h"
#include "third_party/cloud_cpp/google/cloud/storage/internal/curl_request_builder.h"
#include "third_party/json/src/json.hpp"
#include "third_party/cloud_cpp/google/cloud/storage/internal/openssl_util.h"
#include "third_party/cloud_cpp/google/cloud/storage/oauth2/credential_constants.h"
#include "third_party/cloud_cpp/google/cloud/storage/oauth2/credentials.h"
#include "third_party/cloud_cpp/google/cloud/storage/oauth2/refreshing_credentials_wrapper.h"
...
class ComputeEngineCredentials : public Credentials {
 ...
 private:
  ...
  Status RetrieveServiceAccountInfo() const {
    ...
    auto response_body =
        nlohmann::json::parse(response->payload, nullptr, false);
  ...
  StatusOr<RefreshingCredentialsWrapper::TemporaryToken> Refresh() const {
    ...
    // "token_type".
    nlohmann::json access_token = nlohmann::json::parse(response->payload, nullptr, false);
