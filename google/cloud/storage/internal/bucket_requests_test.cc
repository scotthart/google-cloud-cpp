...
TEST(PatchBucketRequestTest, DiffSetAcl) {
  ...
  nlohmann::json patch = nlohmann::json::parse(request.payload());
...
TEST(PatchBucketRequestTest, DiffResetAcl) {
  ...
  nlohmann::json patch = nlohmann::json::parse(request.payload());
  nlohmann::json expected = nlohmann::json::parse(R"""({"acl": null})""");
  EXPECT_EQ(expected, patch);
}
...
TEST(PatchBucketRequestTest, DiffResetBilling) {
  ...
  nlohmann::json patch = nlohmann::json::parse(request.payload());
  nlohmann::json expected = nlohmann::json::parse(R"""({"billing": null})""");
  EXPECT_EQ(expected, patch);
}
...
TEST(PatchBucketRequestTest, DiffResetCors) {
  ...
  nlohmann::json patch = nlohmann::json::parse(request.payload());
  nlohmann::json expected = nlohmann::json::parse(R"""({"cors": null})""");
  EXPECT_EQ(expected, patch);
}
...
TEST(PatchBucketRequestTest, DiffResetDefaultAcl) {
  ...
  nlohmann::json patch = nlohmann::json::parse(request.payload());
  nlohmann::json expected = nlohmann::json::parse(R"""({"defaultObjectAcl": null})""");
  EXPECT_EQ(expected, patch);
}
...
TEST(PatchBucketRequestTest, DiffResetEncryption) {
  ...
  nlohmann::json patch = nlohmann::json::parse(request.payload());
  nlohmann::json expected = nlohmann::json::parse(R"""({"encryption": null})""");
  EXPECT_EQ(expected, patch);
}
...
TEST(PatchBucketRequestTest, DiffResetIamConfiguration) {
  ...
  nlohmann::json patch = nlohmann::json::parse(request.payload());
  nlohmann::json expected = nlohmann::json::parse(R"""({"iamConfiguration": null})""");
  EXPECT_EQ(expected, patch);
}
...
TEST(PatchBucketRequestTest, DiffResetLabels) {
  ...
  nlohmann::json patch = nlohmann::json::parse(request.payload());
  nlohmann::json expected = nlohmann::json::parse(R"""({"labels": null})""");
  EXPECT_EQ(expected, patch);
}
...
TEST(PatchBucketRequestTest, DiffResetLifecycle) {
  ...
  nlohmann::json patch = nlohmann::json::parse(request.payload());
  nlohmann::json expected = nlohmann::json::parse(R"""({"lifecycle": null})""");
  EXPECT_EQ(expected, patch);
}
...
TEST(PatchBucketRequestTest, DiffResetLogging) {
  ...
  nlohmann::json patch = nlohmann::json::parse(request.payload());
  nlohmann::json expected = nlohmann::json::parse(R"""({"logging": null})""");
  EXPECT_EQ(expected, patch);
}
...
TEST(PatchBucketRequestTest, DiffSetName) {
  ...
  nlohmann::json patch = nlohmann::json::parse(request.payload());
  nlohmann::json expected = nlohmann::json::parse(R"""({"name": "new-bucket-name"})""");
  EXPECT_EQ(expected, patch);
}
...
TEST(PatchBucketRequestTest, DiffResetName) {
  ...
  nlohmann::json patch = nlohmann::json::parse(request.payload());
  nlohmann::json expected = nlohmann::json::parse(R"""({"name": null})""");
  EXPECT_EQ(expected, patch);
}
...
TEST(PatchBucketRequestTest, DiffResetRetentionPolicy) {
  ...
  nlohmann::json patch = nlohmann::json::parse(request.payload());
  nlohmann::json expected = nlohmann::json::parse(R"""({"retentionPolicy": null})""");
  EXPECT_EQ(expected, patch);
}
...
TEST(PatchBucketRequestTest, DiffSetStorageClass) {
  ...
  nlohmann::json patch = nlohmann::json::parse(request.payload());
  nlohmann::json expected = nlohmann::json::parse(R"""({"storageClass": "COLDLINE"})""");
  EXPECT_EQ(expected, patch);
}
...
TEST(PatchBucketRequestTest, DiffResetStorageClass) {
  ...
  nlohmann::json patch = nlohmann::json::parse(request.payload());
  nlohmann::json expected = nlohmann::json::parse(R"""({"storageClass": null})""");
  EXPECT_EQ(expected, patch);
}
...
TEST(PatchBucketRequestTest, DiffResetVersioning) {
  ...
  nlohmann::json patch = nlohmann::json::parse(request.payload());
  nlohmann::json expected = nlohmann::json::parse(R"""({"versioning": null})""");
  EXPECT_EQ(expected, patch);
}
...
TEST(PatchBucketRequestTest, DiffResetWebsite) {
  ...
  nlohmann::json patch = nlohmann::json::parse(request.payload());
  nlohmann::json expected = nlohmann::json::parse(R"""({"website": null})""");
  EXPECT_EQ(expected, patch);
}
