...
TEST(PatchObjectRequestTest, DiffSetCacheControl) {
  ...
  nlohmann::json patch = nlohmann::json::parse(request.payload());
  nlohmann::json expected = nlohmann::json::parse(R"""({"cacheControl": "no-cache"})""");
  EXPECT_EQ(expected, patch);
}
...
TEST(PatchObjectRequestTest, DiffResetCacheControl) {
  ...
  nlohmann::json patch = nlohmann::json::parse(request.payload());
  nlohmann::json expected = nlohmann::json::parse(R"""({"cacheControl": null})""");
  EXPECT_EQ(expected, patch);
}
...
TEST(PatchObjectRequestTest, DiffResetContentDisposition) {
  ...
  nlohmann::json patch = nlohmann::json::parse(request.payload());
  nlohmann::json expected = nlohmann::json::parse(R"""({"contentDisposition": null})""");
  EXPECT_EQ(expected, patch);
}
...
TEST(PatchObjectRequestTest, DiffResetContentEncoding) {
  ...
  nlohmann::json patch = nlohmann::json::parse(request.payload());
  nlohmann::json expected = nlohmann::json::parse(R"""({"contentEncoding": null})""");
  EXPECT_EQ(expected, patch);
}
...
TEST(PatchObjectRequestTest, DiffResetContentLanguage) {
  ...
  nlohmann::json patch = nlohmann::json::parse(request.payload());
  nlohmann::json expected = nlohmann::json::parse(R"""({"contentLanguage": null})""");
  EXPECT_EQ(expected, patch);
}
...
TEST(PatchObjectRequestTest, DiffSetContentType) {
  ...
  nlohmann::json patch = nlohmann::json::parse(request.payload());
  nlohmann::json expected = nlohmann::json::parse(R"""({"contentType": "test-value"})""");
  EXPECT_EQ(expected, patch);
}
...
TEST(PatchObjectRequestTest, DiffResetContentType) {
  ...
  nlohmann::json patch = nlohmann::json::parse(request.payload());
  nlohmann::json expected = nlohmann::json::parse(R"""({"contentType": null})""");
  EXPECT_EQ(expected, patch);
}
...
TEST(PatchObjectRequestTest, DiffSetEventBasedHold) {
  ...
  nlohmann::json patch = nlohmann::json::parse(request.payload());
  nlohmann::json expected = nlohmann::json::parse(R"""({"eventBasedHold": true})""");
  EXPECT_EQ(expected, patch);
}
...
TEST(PatchObjectRequestTest, DiffResetLabels) {
  ...
  nlohmann::json patch = nlohmann::json::parse(request.payload());
  nlohmann::json expected = nlohmann::json::parse(R"""({"metadata": null})""");
  EXPECT_EQ(expected, patch);
}
...
TEST(PatchObjectRequestTest, DiffSetTemporaryHold) {
  ...
  nlohmann::json patch = nlohmann::json::parse(request.payload());
  nlohmann::json expected = nlohmann::json::parse(R"""({"temporaryHold": true})""");
  EXPECT_EQ(expected, patch);
}
