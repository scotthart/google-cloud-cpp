...
ResourceSettingsServiceConnection::~ResourceSettingsServiceConnection() = default;

StreamRange<google::cloud::resourcesettings::v1::Setting> ResourceSettingsServiceConnection::ListSettings(
    google::cloud::resourcesettings::v1::ListSettingsRequest) {  // NOLINT(performance-unnecessary-value-param)
...
std::shared_ptr<ResourceSettingsServiceConnection> MakeResourceSettingsServiceConnection(
  ...
  internal::CheckExpectedOptions<CommonOptionList, GrpcOptionList,
      ...
      ResourceSettingsServicePolicyOptionList>(options, __func__);
  options = resourcesettings_v1_internal::ResourceSettingsServiceDefaultOptions(
      std::move(options));
  auto background = internal::MakeBackgroundThreadsFactory(options)();
  auto auth = internal::CreateAuthenticationStrategy(background->cq(), options);
  auto stub = resourcesettings_v1_internal::CreateDefaultResourceSettingsServiceStub(
    std::move(auth), options);
  return resourcesettings_v1_internal::MakeResourceSettingsServiceTracingConnection(
      std::make_shared<resourcesettings_v1_internal::ResourceSettingsServiceConnectionImpl>(
