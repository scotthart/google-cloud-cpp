...
// clang-format off
// main-dox-marker: tpu_v1::TpuClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::tpu_v1::TpuClient(
...
class CustomIdempotencyPolicy
 ...
 public:
  ...
  std::unique_ptr<google::cloud::tpu_v1::TpuConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto c3 = google::cloud::tpu_v1::TpuClient(
    connection, google::cloud::Options{}.set<google::cloud::tpu_v1::TpuRetryPolicyOption>(
      google::cloud::tpu_v1::TpuLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::tpu_v1::TpuPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::tpu_v1::TpuRetryPolicyOption::Type,
            google::cloud::tpu_v1::TpuBackoffPolicyOption::Type>(
