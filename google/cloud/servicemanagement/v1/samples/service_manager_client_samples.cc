...
// clang-format off
// main-dox-marker: servicemanagement_v1::ServiceManagerClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::servicemanagement_v1::ServiceManagerClient(
      google::cloud::servicemanagement_v1::MakeServiceManagerConnection(options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::servicemanagement_v1::ServiceManagerConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::servicemanagement_v1::ServiceManagerConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::servicemanagement_v1::ServiceManagerConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::servicemanagement_v1::ServiceManagerRetryPolicyOption>(
      google::cloud::servicemanagement_v1::ServiceManagerLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::servicemanagement_v1::ServiceManagerBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::servicemanagement_v1::MakeServiceManagerConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::servicemanagement_v1::ServiceManagerClient(connection);
  auto c2 = google::cloud::servicemanagement_v1::ServiceManagerClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::servicemanagement_v1::ServiceManagerClient(
    connection, google::cloud::Options{}.set<google::cloud::servicemanagement_v1::ServiceManagerRetryPolicyOption>(
      google::cloud::servicemanagement_v1::ServiceManagerLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::servicemanagement_v1::ServiceManagerRetryPolicyOption>(
  //       google::cloud::servicemanagement_v1::ServiceManagerLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::servicemanagement_v1::ServiceManagerPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::servicemanagement_v1::ServiceManagerRetryPolicyOption::Type,
            google::cloud::servicemanagement_v1::ServiceManagerBackoffPolicyOption::Type>(
            google::cloud::servicemanagement_v1::ServiceManagerLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::servicemanagement_v1::ServiceManagerClient(
      google::cloud::servicemanagement_v1::MakeServiceManagerConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
