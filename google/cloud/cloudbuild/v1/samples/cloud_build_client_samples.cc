...
class CustomIdempotencyPolicy
   : public google::cloud::cloudbuild_v1::CloudBuildConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::cloudbuild_v1::CloudBuildConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::cloudbuild_v1::CloudBuildConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::cloudbuild_v1::CloudBuildRetryPolicyOption>(
      google::cloud::cloudbuild_v1::CloudBuildLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::cloudbuild_v1::CloudBuildBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::cloudbuild_v1::MakeCloudBuildConnection(options);
  ...
  auto c3 = google::cloud::cloudbuild_v1::CloudBuildClient(
    connection, google::cloud::Options{}.set<google::cloud::cloudbuild_v1::CloudBuildRetryPolicyOption>(
      google::cloud::cloudbuild_v1::CloudBuildLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::cloudbuild_v1::CloudBuildPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::cloudbuild_v1::CloudBuildRetryPolicyOption::Type,
            google::cloud::cloudbuild_v1::CloudBuildBackoffPolicyOption::Type>(
