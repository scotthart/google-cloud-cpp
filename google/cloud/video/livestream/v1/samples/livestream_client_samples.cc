...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::video_livestream_v1::LivestreamServiceClient(
      google::cloud::video_livestream_v1::MakeLivestreamServiceConnection(options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::video_livestream_v1::LivestreamServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::video_livestream_v1::LivestreamServiceConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::video_livestream_v1::LivestreamServiceConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::video_livestream_v1::LivestreamServiceRetryPolicyOption>(
      google::cloud::video_livestream_v1::LivestreamServiceLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::video_livestream_v1::LivestreamServiceBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::video_livestream_v1::MakeLivestreamServiceConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::video_livestream_v1::LivestreamServiceClient(connection);
  auto c2 = google::cloud::video_livestream_v1::LivestreamServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::video_livestream_v1::LivestreamServiceClient(
    connection, google::cloud::Options{}.set<google::cloud::video_livestream_v1::LivestreamServiceRetryPolicyOption>(
      google::cloud::video_livestream_v1::LivestreamServiceLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::video_livestream_v1::LivestreamServicePollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::video_livestream_v1::LivestreamServiceRetryPolicyOption::Type,
            google::cloud::video_livestream_v1::LivestreamServiceBackoffPolicyOption::Type>(
            google::cloud::video_livestream_v1::LivestreamServiceLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::video_livestream_v1::LivestreamServiceClient(
      google::cloud::video_livestream_v1::MakeLivestreamServiceConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
