...
// clang-format off
// main-dox-marker: alloydb_v1::AlloyDBAdminClient
// lro-marker: true
// clang-format on
namespace {
...
class CustomIdempotencyPolicy
   : public google::cloud::alloydb_v1::AlloyDBAdminConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::alloydb_v1::AlloyDBAdminConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::alloydb_v1::AlloyDBAdminConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::alloydb_v1::AlloyDBAdminRetryPolicyOption>(
      google::cloud::alloydb_v1::AlloyDBAdminLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::alloydb_v1::AlloyDBAdminBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::alloydb_v1::MakeAlloyDBAdminConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::alloydb_v1::AlloyDBAdminClient(connection);
  auto c2 = google::cloud::alloydb_v1::AlloyDBAdminClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::alloydb_v1::AlloyDBAdminClient(
    connection, google::cloud::Options{}.set<google::cloud::alloydb_v1::AlloyDBAdminRetryPolicyOption>(
      google::cloud::alloydb_v1::AlloyDBAdminLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::alloydb_v1::AlloyDBAdminRetryPolicyOption>(
  //       google::cloud::alloydb_v1::AlloyDBAdminLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::alloydb_v1::AlloyDBAdminPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::alloydb_v1::AlloyDBAdminRetryPolicyOption::Type,
            google::cloud::alloydb_v1::AlloyDBAdminBackoffPolicyOption::Type>(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::alloydb_v1::AlloyDBAdminClient(
      google::cloud::alloydb_v1::MakeAlloyDBAdminConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
