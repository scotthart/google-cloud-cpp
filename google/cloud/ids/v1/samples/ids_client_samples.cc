...
class CustomIdempotencyPolicy
 ...
 public:
  ...
  std::unique_ptr<google::cloud::ids_v1::IDSConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto c3 = google::cloud::ids_v1::IDSClient(
    connection, google::cloud::Options{}.set<google::cloud::ids_v1::IDSRetryPolicyOption>(
      google::cloud::ids_v1::IDSLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::ids_v1::IDSPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::ids_v1::IDSRetryPolicyOption::Type,
            google::cloud::ids_v1::IDSBackoffPolicyOption::Type>(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::ids_v1::IDSClient(
      google::cloud::ids_v1::MakeIDSConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
