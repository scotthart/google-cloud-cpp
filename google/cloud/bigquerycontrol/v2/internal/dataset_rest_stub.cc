...
DefaultDatasetServiceRestStub::GetDataset(
  ...
  query_params.push_back({"dataset_view", std::to_string(request.dataset_view())});
  query_params.push_back({"access_policy_version", std::to_string(request.access_policy_version())});
  ...
  return rest_internal::Get<google::cloud::bigquery::v2::Dataset>(
      *service_, rest_context, request, false,
      absl::StrCat("/", "bigquery", "/", rest_internal::DetermineApiVersion("v2", options), "/", "projects", "/", request.project_id(), "/", "datasets", "/", request.dataset_id()), std::move(query_params));
}
...
DefaultDatasetServiceRestStub::InsertDataset(
  ...
  return rest_internal::Post<google::cloud::bigquery::v2::Dataset>(
      *service_, rest_context, request.dataset(), false,
      absl::StrCat("/", "bigquery", "/", rest_internal::DetermineApiVersion("v2", options), "/", "projects", "/", request.project_id(), "/", "datasets"), std::move(query_params));
}
...
Status DefaultDatasetServiceRestStub::DeleteDataset(
  ...
  std::vector<std::pair<std::string, std::string>> query_params;
  query_params.push_back({"delete_contents", (request.delete_contents() ? "1" : "0")});
  query_params = rest_internal::TrimEmptyQueryParameters(std::move(query_params));
...
DefaultDatasetServiceRestStub::UndeleteDataset(
  ...
  return rest_internal::Post<google::cloud::bigquery::v2::Dataset>(
      *service_, rest_context, request, false,
      absl::StrCat("/", "bigquery", "/", rest_internal::DetermineApiVersion("v2", options), "/", "projects", "/", request.project_id(), "/", "datasets", "/", request.dataset_id(), ":undelete"), std::move(query_params));
}
