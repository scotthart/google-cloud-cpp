...
// clang-format off
// main-dox-marker: appengine_v1::ServicesClient
// lro-marker: true
// clang-format on
namespace {
...
class CustomIdempotencyPolicy
   : public google::cloud::appengine_v1::ServicesConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::appengine_v1::ServicesConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::appengine_v1::ServicesConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::appengine_v1::ServicesRetryPolicyOption>(
      google::cloud::appengine_v1::ServicesLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::appengine_v1::ServicesBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::appengine_v1::MakeServicesConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::appengine_v1::ServicesClient(connection);
  auto c2 = google::cloud::appengine_v1::ServicesClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::appengine_v1::ServicesClient(
    connection, google::cloud::Options{}.set<google::cloud::appengine_v1::ServicesRetryPolicyOption>(
      google::cloud::appengine_v1::ServicesLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::appengine_v1::ServicesRetryPolicyOption>(
  //       google::cloud::appengine_v1::ServicesLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::appengine_v1::ServicesPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::appengine_v1::ServicesRetryPolicyOption::Type,
            google::cloud::appengine_v1::ServicesBackoffPolicyOption::Type>(
            google::cloud::appengine_v1::ServicesLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::appengine_v1::ServicesClient(
      google::cloud::appengine_v1::MakeServicesConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
