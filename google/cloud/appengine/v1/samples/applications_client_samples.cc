...
// clang-format off
// main-dox-marker: appengine_v1::ApplicationsClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::appengine_v1::ApplicationsClient(
      google::cloud::appengine_v1::MakeApplicationsConnection(options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::appengine_v1::ApplicationsConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::appengine_v1::ApplicationsConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::appengine_v1::ApplicationsConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::appengine_v1::ApplicationsRetryPolicyOption>(
      google::cloud::appengine_v1::ApplicationsLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::appengine_v1::ApplicationsBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::appengine_v1::MakeApplicationsConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::appengine_v1::ApplicationsClient(connection);
  auto c2 = google::cloud::appengine_v1::ApplicationsClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::appengine_v1::ApplicationsClient(
    connection, google::cloud::Options{}.set<google::cloud::appengine_v1::ApplicationsRetryPolicyOption>(
      google::cloud::appengine_v1::ApplicationsLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::appengine_v1::ApplicationsRetryPolicyOption>(
  //       google::cloud::appengine_v1::ApplicationsLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::appengine_v1::ApplicationsPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::appengine_v1::ApplicationsRetryPolicyOption::Type,
            google::cloud::appengine_v1::ApplicationsBackoffPolicyOption::Type>(
            google::cloud::appengine_v1::ApplicationsLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::appengine_v1::ApplicationsClient(
      google::cloud::appengine_v1::MakeApplicationsConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
