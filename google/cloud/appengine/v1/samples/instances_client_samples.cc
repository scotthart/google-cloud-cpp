...
#include "google/cloud/appengine/v1/instances_client.h"
...
class CustomIdempotencyPolicy
   : public google::cloud::appengine_v1::InstancesConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::appengine_v1::InstancesConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::appengine_v1::InstancesConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::appengine_v1::InstancesRetryPolicyOption>(
      google::cloud::appengine_v1::InstancesLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::appengine_v1::InstancesBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::appengine_v1::MakeInstancesConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::appengine_v1::InstancesClient(connection);
  auto c2 = google::cloud::appengine_v1::InstancesClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::appengine_v1::InstancesClient(
    connection, google::cloud::Options{}.set<google::cloud::appengine_v1::InstancesRetryPolicyOption>(
      google::cloud::appengine_v1::InstancesLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::appengine_v1::InstancesRetryPolicyOption>(
  //       google::cloud::appengine_v1::InstancesLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::appengine_v1::InstancesPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::appengine_v1::InstancesRetryPolicyOption::Type,
            google::cloud::appengine_v1::InstancesBackoffPolicyOption::Type>(
            google::cloud::appengine_v1::InstancesLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::appengine_v1::InstancesClient(
      google::cloud::appengine_v1::MakeInstancesConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
