...
class CustomIdempotencyPolicy
 ...
 public:
  ...
  std::unique_ptr<google::cloud::dialogflow_cx::AgentsConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::dialogflow_cx::AgentsConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::dialogflow_cx::AgentsRetryPolicyOption>(
      google::cloud::dialogflow_cx::AgentsLimitedErrorCountRetryPolicy(3).clone())
  ...
  auto c3 = google::cloud::dialogflow_cx::AgentsClient(
    connection, google::cloud::Options{}.set<google::cloud::dialogflow_cx::AgentsRetryPolicyOption>(
      google::cloud::dialogflow_cx::AgentsLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::dialogflow_cx::AgentsPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            ...
            google::cloud::dialogflow_cx::AgentsBackoffPolicyOption::Type>(
