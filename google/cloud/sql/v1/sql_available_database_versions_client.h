...
class SqlAvailableDatabaseVersionsServiceClient {
 ...
 private:
  std::shared_ptr<SqlAvailableDatabaseVersionsServiceConnection> connection_;
  Options options_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQL_V1_SQL_AVAILABLE_DATABASE_VERSIONS_CLIENT_H
