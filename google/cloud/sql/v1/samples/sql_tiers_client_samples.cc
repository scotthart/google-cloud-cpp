...
class CustomIdempotencyPolicy
   : public google::cloud::sql_v1::SqlTiersServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::sql_v1::SqlTiersServiceConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::sql_v1::SqlTiersServiceConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::sql_v1::SqlTiersServiceRetryPolicyOption>(
      google::cloud::sql_v1::SqlTiersServiceLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::sql_v1::SqlTiersServiceBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::sql_v1::MakeSqlTiersServiceConnectionRest(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::sql_v1::SqlTiersServiceClient(connection);
  auto c2 = google::cloud::sql_v1::SqlTiersServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::sql_v1::SqlTiersServiceClient(
    connection, google::cloud::Options{}.set<google::cloud::sql_v1::SqlTiersServiceRetryPolicyOption>(
      google::cloud::sql_v1::SqlTiersServiceLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::sql_v1::SqlTiersServiceRetryPolicyOption>(
  //       google::cloud::sql_v1::SqlTiersServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::sql_v1::SqlTiersServiceClient(
      google::cloud::sql_v1::MakeSqlTiersServiceConnectionRest(options));
  }
  //! [with-service-account]
  (argv.at(0));
