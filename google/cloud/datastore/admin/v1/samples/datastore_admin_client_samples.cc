...
class CustomIdempotencyPolicy
   : public google::cloud::datastore_admin_v1::DatastoreAdminConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::datastore_admin_v1::DatastoreAdminConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::datastore_admin_v1::DatastoreAdminConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::datastore_admin_v1::DatastoreAdminRetryPolicyOption>(
      google::cloud::datastore_admin_v1::DatastoreAdminLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::datastore_admin_v1::DatastoreAdminBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::datastore_admin_v1::MakeDatastoreAdminConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::datastore_admin_v1::DatastoreAdminClient(connection);
  auto c2 = google::cloud::datastore_admin_v1::DatastoreAdminClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::datastore_admin_v1::DatastoreAdminClient(
    connection, google::cloud::Options{}.set<google::cloud::datastore_admin_v1::DatastoreAdminRetryPolicyOption>(
      google::cloud::datastore_admin_v1::DatastoreAdminLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::datastore_admin_v1::DatastoreAdminRetryPolicyOption>(
  //       google::cloud::datastore_admin_v1::DatastoreAdminLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::datastore_admin_v1::DatastoreAdminPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::datastore_admin_v1::DatastoreAdminRetryPolicyOption::Type,
            google::cloud::datastore_admin_v1::DatastoreAdminBackoffPolicyOption::Type>(
            google::cloud::datastore_admin_v1::DatastoreAdminLimitedTimeRetryPolicy(
