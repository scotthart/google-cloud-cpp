...
std::unique_ptr<gkeconnect_gateway_v1::GatewayControlRetryPolicy>
...
std::unique_ptr<gkeconnect_gateway_v1::GatewayControlConnectionIdempotencyPolicy>
...
GatewayControlConnectionImpl::GenerateCredentials(google::cloud::gkeconnect::gateway::v1::GenerateCredentialsRequest const& request) {
