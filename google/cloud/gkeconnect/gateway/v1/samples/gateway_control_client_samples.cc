...
// clang-format off
// main-dox-marker: gkeconnect_gateway_v1::GatewayControlClient
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::gkeconnect_gateway_v1::GatewayControlClient(
      google::cloud::gkeconnect_gateway_v1::MakeGatewayControlConnection(options));
  //! [set-client-endpoint]
}
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    ...
    .set<google::cloud::gkeconnect_gateway_v1::GatewayControlBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          ...
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::gkeconnect_gateway_v1::MakeGatewayControlConnection(options);
  ...
  //     .set<google::cloud::gkeconnect_gateway_v1::GatewayControlRetryPolicyOption>(
  //       google::cloud::gkeconnect_gateway_v1::GatewayControlLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
