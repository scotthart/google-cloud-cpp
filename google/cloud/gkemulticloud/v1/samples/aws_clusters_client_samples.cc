...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::gkemulticloud_v1::AwsClustersClient(
      google::cloud::gkemulticloud_v1::MakeAwsClustersConnection("unused", options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::gkemulticloud_v1::AwsClustersConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::gkemulticloud_v1::AwsClustersConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::gkemulticloud_v1::AwsClustersConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::gkemulticloud_v1::AwsClustersRetryPolicyOption>(
      google::cloud::gkemulticloud_v1::AwsClustersLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::gkemulticloud_v1::AwsClustersBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::gkemulticloud_v1::MakeAwsClustersConnection("location-unused-in-this-example", options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::gkemulticloud_v1::AwsClustersClient(connection);
  auto c2 = google::cloud::gkemulticloud_v1::AwsClustersClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::gkemulticloud_v1::AwsClustersClient(
    connection, google::cloud::Options{}.set<google::cloud::gkemulticloud_v1::AwsClustersRetryPolicyOption>(
      google::cloud::gkemulticloud_v1::AwsClustersLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::gkemulticloud_v1::AwsClustersRetryPolicyOption>(
  //       google::cloud::gkemulticloud_v1::AwsClustersLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::gkemulticloud_v1::AwsClustersPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::gkemulticloud_v1::AwsClustersRetryPolicyOption::Type,
            google::cloud::gkemulticloud_v1::AwsClustersBackoffPolicyOption::Type>(
            google::cloud::gkemulticloud_v1::AwsClustersLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::gkemulticloud_v1::AwsClustersClient(
      google::cloud::gkemulticloud_v1::MakeAwsClustersConnection("us-west1" /* regional service region */, options));
  }
  //! [with-service-account]
  (argv.at(0));
}
