...
class CustomIdempotencyPolicy
   : public google::cloud::edgecontainer_v1::EdgeContainerConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::edgecontainer_v1::EdgeContainerConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::edgecontainer_v1::EdgeContainerConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::edgecontainer_v1::EdgeContainerRetryPolicyOption>(
      google::cloud::edgecontainer_v1::EdgeContainerLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::edgecontainer_v1::EdgeContainerBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::edgecontainer_v1::MakeEdgeContainerConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::edgecontainer_v1::EdgeContainerClient(connection);
  auto c2 = google::cloud::edgecontainer_v1::EdgeContainerClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::edgecontainer_v1::EdgeContainerClient(
    connection, google::cloud::Options{}.set<google::cloud::edgecontainer_v1::EdgeContainerRetryPolicyOption>(
      google::cloud::edgecontainer_v1::EdgeContainerLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::edgecontainer_v1::EdgeContainerRetryPolicyOption>(
  //       google::cloud::edgecontainer_v1::EdgeContainerLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::edgecontainer_v1::EdgeContainerPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::edgecontainer_v1::EdgeContainerRetryPolicyOption::Type,
            google::cloud::edgecontainer_v1::EdgeContainerBackoffPolicyOption::Type>(
            google::cloud::edgecontainer_v1::EdgeContainerLimitedTimeRetryPolicy(
