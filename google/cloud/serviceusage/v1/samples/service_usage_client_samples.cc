...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::serviceusage_v1::ServiceUsageClient(
      google::cloud::serviceusage_v1::MakeServiceUsageConnection(options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::serviceusage_v1::ServiceUsageConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::serviceusage_v1::ServiceUsageConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::serviceusage_v1::ServiceUsageConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::serviceusage_v1::ServiceUsageRetryPolicyOption>(
      google::cloud::serviceusage_v1::ServiceUsageLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::serviceusage_v1::ServiceUsageBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::serviceusage_v1::MakeServiceUsageConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::serviceusage_v1::ServiceUsageClient(connection);
  auto c2 = google::cloud::serviceusage_v1::ServiceUsageClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::serviceusage_v1::ServiceUsageClient(
    connection, google::cloud::Options{}.set<google::cloud::serviceusage_v1::ServiceUsageRetryPolicyOption>(
      google::cloud::serviceusage_v1::ServiceUsageLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::serviceusage_v1::ServiceUsageRetryPolicyOption>(
  //       google::cloud::serviceusage_v1::ServiceUsageLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::serviceusage_v1::ServiceUsagePollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::serviceusage_v1::ServiceUsageRetryPolicyOption::Type,
            google::cloud::serviceusage_v1::ServiceUsageBackoffPolicyOption::Type>(
            google::cloud::serviceusage_v1::ServiceUsageLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::serviceusage_v1::ServiceUsageClient(
      google::cloud::serviceusage_v1::MakeServiceUsageConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
