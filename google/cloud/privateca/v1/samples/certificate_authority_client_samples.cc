...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::privateca_v1::CertificateAuthorityServiceClient(
      google::cloud::privateca_v1::MakeCertificateAuthorityServiceConnection(options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::privateca_v1::CertificateAuthorityServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::privateca_v1::CertificateAuthorityServiceConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::privateca_v1::CertificateAuthorityServiceConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::privateca_v1::CertificateAuthorityServiceRetryPolicyOption>(
      google::cloud::privateca_v1::CertificateAuthorityServiceLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::privateca_v1::CertificateAuthorityServiceBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::privateca_v1::MakeCertificateAuthorityServiceConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::privateca_v1::CertificateAuthorityServiceClient(connection);
  auto c2 = google::cloud::privateca_v1::CertificateAuthorityServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::privateca_v1::CertificateAuthorityServiceClient(
    connection, google::cloud::Options{}.set<google::cloud::privateca_v1::CertificateAuthorityServiceRetryPolicyOption>(
      google::cloud::privateca_v1::CertificateAuthorityServiceLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::privateca_v1::CertificateAuthorityServiceRetryPolicyOption>(
  //       google::cloud::privateca_v1::CertificateAuthorityServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::privateca_v1::CertificateAuthorityServicePollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::privateca_v1::CertificateAuthorityServiceRetryPolicyOption::Type,
            google::cloud::privateca_v1::CertificateAuthorityServiceBackoffPolicyOption::Type>(
            google::cloud::privateca_v1::CertificateAuthorityServiceLimitedTimeRetryPolicy(
