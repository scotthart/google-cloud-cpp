...
class CustomIdempotencyPolicy
 ...
 public:
  ...
  std::unique_ptr<google::cloud::run_v2::JobsConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    ...
    .set<google::cloud::run_v2::JobsRetryPolicyOption>(
      google::cloud::run_v2::JobsLimitedErrorCountRetryPolicy(3).clone())
  ...
  auto c3 = google::cloud::run_v2::JobsClient(
    connection, google::cloud::Options{}.set<google::cloud::run_v2::JobsRetryPolicyOption>(
      google::cloud::run_v2::JobsLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::run_v2::JobsPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::run_v2::JobsRetryPolicyOption::Type,
            google::cloud::run_v2::JobsBackoffPolicyOption::Type>(
