...
// clang-format off
// main-dox-marker: run_v2::ServicesClient
// lro-marker: true
// clang-format on
namespace {
...
class CustomIdempotencyPolicy
 ...
 public:
  ...
  std::unique_ptr<google::cloud::run_v2::ServicesConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::run_v2::ServicesConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::run_v2::ServicesRetryPolicyOption>(
      google::cloud::run_v2::ServicesLimitedErrorCountRetryPolicy(3).clone())
  ...
  auto c3 = google::cloud::run_v2::ServicesClient(
    connection, google::cloud::Options{}.set<google::cloud::run_v2::ServicesRetryPolicyOption>(
      google::cloud::run_v2::ServicesLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::run_v2::ServicesPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::run_v2::ServicesRetryPolicyOption::Type,
            google::cloud::run_v2::ServicesBackoffPolicyOption::Type>(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::run_v2::ServicesClient(
      google::cloud::run_v2::MakeServicesConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
