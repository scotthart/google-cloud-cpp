...
// clang-format off
// main-dox-marker: run_v2::RevisionsClient
// lro-marker: true
// clang-format on
namespace {
...
class CustomIdempotencyPolicy
 ...
 public:
  ...
  std::unique_ptr<google::cloud::run_v2::RevisionsConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::run_v2::RevisionsConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::run_v2::RevisionsRetryPolicyOption>(
      google::cloud::run_v2::RevisionsLimitedErrorCountRetryPolicy(3).clone())
  ...
  auto c3 = google::cloud::run_v2::RevisionsClient(
    connection, google::cloud::Options{}.set<google::cloud::run_v2::RevisionsRetryPolicyOption>(
      google::cloud::run_v2::RevisionsLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::run_v2::RevisionsPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::run_v2::RevisionsRetryPolicyOption::Type,
            google::cloud::run_v2::RevisionsBackoffPolicyOption::Type>(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::run_v2::RevisionsClient(
      google::cloud::run_v2::MakeRevisionsConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
