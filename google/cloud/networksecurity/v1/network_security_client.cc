...
StatusOr<google::longrunning::Operation>
NetworkSecurityClient::DeleteAuthorizationPolicy(google::cloud::ExperimentalTag,
...
StatusOr<google::longrunning::Operation>
NetworkSecurityClient::DeleteServerTlsPolicy(google::cloud::ExperimentalTag,
                                             google::cloud::NoAwaitTag,
                                             std::string const& name,
                                             Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
...
StatusOr<google::longrunning::Operation>
NetworkSecurityClient::DeleteClientTlsPolicy(google::cloud::ExperimentalTag,
                                             google::cloud::NoAwaitTag,
                                             std::string const& name,
                                             Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
