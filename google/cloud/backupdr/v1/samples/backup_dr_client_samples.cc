...
// clang-format off
// main-dox-marker: backupdr_v1::BackupDRClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::backupdr_v1::BackupDRClient(
...
class CustomIdempotencyPolicy
   : public google::cloud::backupdr_v1::BackupDRConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::backupdr_v1::BackupDRConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::backupdr_v1::BackupDRConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::backupdr_v1::BackupDRRetryPolicyOption>(
      google::cloud::backupdr_v1::BackupDRLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::backupdr_v1::BackupDRBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::backupdr_v1::MakeBackupDRConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::backupdr_v1::BackupDRClient(connection);
  auto c2 = google::cloud::backupdr_v1::BackupDRClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::backupdr_v1::BackupDRClient(
    connection, google::cloud::Options{}.set<google::cloud::backupdr_v1::BackupDRRetryPolicyOption>(
      google::cloud::backupdr_v1::BackupDRLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::backupdr_v1::BackupDRRetryPolicyOption>(
  //       google::cloud::backupdr_v1::BackupDRLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::backupdr_v1::BackupDRPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::backupdr_v1::BackupDRRetryPolicyOption::Type,
            google::cloud::backupdr_v1::BackupDRBackoffPolicyOption::Type>(
            google::cloud::backupdr_v1::BackupDRLimitedTimeRetryPolicy(
