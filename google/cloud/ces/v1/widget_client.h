...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CES_V1_WIDGET_CLIENT_H
...
class WidgetServiceClient {
 public:
  explicit WidgetServiceClient(
      std::shared_ptr<WidgetServiceConnection> connection, Options opts = {});
  ~WidgetServiceClient();

  ///@{
  /// @name Copy and move support
  WidgetServiceClient(WidgetServiceClient const&) = default;
  WidgetServiceClient& operator=(WidgetServiceClient const&) = default;
  WidgetServiceClient(WidgetServiceClient&&) = default;
  WidgetServiceClient& operator=(WidgetServiceClient&&) = default;
  ///@}

  ///@{
  /// @name Equality
  friend bool operator==(WidgetServiceClient const& a,
                         WidgetServiceClient const& b) {
  ...
  ///     ([google.cloud.ces.v1.GenerateChatTokenResponse])
 ...
 private:
  std::shared_ptr<WidgetServiceConnection> connection_;
  Options options_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CES_V1_WIDGET_CLIENT_H
