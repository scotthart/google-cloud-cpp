...
class CustomIdempotencyPolicy
   : public google::cloud::memcache_v1::CloudMemcacheConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::memcache_v1::CloudMemcacheConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::memcache_v1::CloudMemcacheConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::memcache_v1::CloudMemcacheRetryPolicyOption>(
      google::cloud::memcache_v1::CloudMemcacheLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::memcache_v1::CloudMemcacheBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::memcache_v1::MakeCloudMemcacheConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::memcache_v1::CloudMemcacheClient(connection);
  auto c2 = google::cloud::memcache_v1::CloudMemcacheClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::memcache_v1::CloudMemcacheClient(
    connection, google::cloud::Options{}.set<google::cloud::memcache_v1::CloudMemcacheRetryPolicyOption>(
      google::cloud::memcache_v1::CloudMemcacheLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::memcache_v1::CloudMemcacheRetryPolicyOption>(
  //       google::cloud::memcache_v1::CloudMemcacheLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::memcache_v1::CloudMemcachePollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::memcache_v1::CloudMemcacheRetryPolicyOption::Type,
            google::cloud::memcache_v1::CloudMemcacheBackoffPolicyOption::Type>(
            google::cloud::memcache_v1::CloudMemcacheLimitedTimeRetryPolicy(
