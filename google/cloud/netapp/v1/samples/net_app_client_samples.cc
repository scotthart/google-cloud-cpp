...
// clang-format off
// main-dox-marker: netapp_v1::NetAppClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::netapp_v1::NetAppClient(
      google::cloud::netapp_v1::MakeNetAppConnection(options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::netapp_v1::NetAppConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::netapp_v1::NetAppConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::netapp_v1::NetAppConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::netapp_v1::NetAppRetryPolicyOption>(
      google::cloud::netapp_v1::NetAppLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::netapp_v1::NetAppBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::netapp_v1::MakeNetAppConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::netapp_v1::NetAppClient(connection);
  auto c2 = google::cloud::netapp_v1::NetAppClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::netapp_v1::NetAppClient(
    connection, google::cloud::Options{}.set<google::cloud::netapp_v1::NetAppRetryPolicyOption>(
      google::cloud::netapp_v1::NetAppLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::netapp_v1::NetAppRetryPolicyOption>(
  //       google::cloud::netapp_v1::NetAppLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::netapp_v1::NetAppPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::netapp_v1::NetAppRetryPolicyOption::Type,
            google::cloud::netapp_v1::NetAppBackoffPolicyOption::Type>(
            google::cloud::netapp_v1::NetAppLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::netapp_v1::NetAppClient(
      google::cloud::netapp_v1::MakeNetAppConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
