...
// clang-format off
// main-dox-marker: publicca_v1::PublicCertificateAuthorityServiceClient
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::publicca_v1::PublicCertificateAuthorityServiceClient(
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  //     .set<google::cloud::publicca_v1::PublicCertificateAuthorityServiceRetryPolicyOption>(
  //       google::cloud::publicca_v1::PublicCertificateAuthorityServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
