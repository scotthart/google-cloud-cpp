...
class CustomIdempotencyPolicy
 ...
 public:
  ...
  std::unique_ptr<google::cloud::workflows_v1::WorkflowsConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::workflows_v1::WorkflowsConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::workflows_v1::WorkflowsRetryPolicyOption>(
      google::cloud::workflows_v1::WorkflowsLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::workflows_v1::WorkflowsBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::workflows_v1::MakeWorkflowsConnection(options);
  ...
  auto c3 = google::cloud::workflows_v1::WorkflowsClient(
    connection, google::cloud::Options{}.set<google::cloud::workflows_v1::WorkflowsRetryPolicyOption>(
      google::cloud::workflows_v1::WorkflowsLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::workflows_v1::WorkflowsPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            ...
            google::cloud::workflows_v1::WorkflowsBackoffPolicyOption::Type>(
