...
// clang-format off
// main-dox-marker: managedkafka_v1::ManagedKafkaClient
// lro-marker: true
// clang-format on
namespace {
...
class CustomIdempotencyPolicy
   : public google::cloud::managedkafka_v1::ManagedKafkaConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::managedkafka_v1::ManagedKafkaConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::managedkafka_v1::ManagedKafkaConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::managedkafka_v1::ManagedKafkaRetryPolicyOption>(
      google::cloud::managedkafka_v1::ManagedKafkaLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::managedkafka_v1::ManagedKafkaBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::managedkafka_v1::MakeManagedKafkaConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::managedkafka_v1::ManagedKafkaClient(connection);
  auto c2 = google::cloud::managedkafka_v1::ManagedKafkaClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::managedkafka_v1::ManagedKafkaClient(
    connection, google::cloud::Options{}.set<google::cloud::managedkafka_v1::ManagedKafkaRetryPolicyOption>(
      google::cloud::managedkafka_v1::ManagedKafkaLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::managedkafka_v1::ManagedKafkaRetryPolicyOption>(
  //       google::cloud::managedkafka_v1::ManagedKafkaLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::managedkafka_v1::ManagedKafkaPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::managedkafka_v1::ManagedKafkaRetryPolicyOption::Type,
            google::cloud::managedkafka_v1::ManagedKafkaBackoffPolicyOption::Type>(
            google::cloud::managedkafka_v1::ManagedKafkaLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::managedkafka_v1::ManagedKafkaClient(
      google::cloud::managedkafka_v1::MakeManagedKafkaConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
