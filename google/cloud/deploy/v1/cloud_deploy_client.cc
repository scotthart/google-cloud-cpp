...
StatusOr<google::longrunning::Operation>
CloudDeployClient::DeleteDeliveryPipeline(google::cloud::ExperimentalTag,
...
StatusOr<google::longrunning::Operation> CloudDeployClient::CreateTarget(
    google::cloud::ExperimentalTag, google::cloud::NoAwaitTag,
    std::string const& parent, google::cloud::deploy::v1::Target const& target,
    std::string const& target_id, Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
  google::cloud::deploy::v1::CreateTargetRequest request;
  request.set_parent(parent);
...
StatusOr<google::longrunning::Operation>
CloudDeployClient::DeleteCustomTargetType(google::cloud::ExperimentalTag,
                                          google::cloud::NoAwaitTag,
                                          std::string const& name,
                                          Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
