...
/**
 * Control the Cloud C++ client library behavior with respect to polling
 * on long running operations.
 *
 * Some operations return a `google.longrunning.Operation`
 * object. As their name implies, these objects represent requests that may take
 * a long time to complete.
 *
 * The client library models these long running operations
