...
class CustomIdempotencyPolicy
   : public google::cloud::pubsublite::TopicStatsServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::pubsublite::TopicStatsServiceConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::pubsublite::TopicStatsServiceConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::pubsublite::TopicStatsServiceRetryPolicyOption>(
      google::cloud::pubsublite::TopicStatsServiceLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::pubsublite::TopicStatsServiceBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::pubsublite::MakeTopicStatsServiceConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::pubsublite::TopicStatsServiceClient(connection);
  auto c2 = google::cloud::pubsublite::TopicStatsServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::pubsublite::TopicStatsServiceClient(
    connection, google::cloud::Options{}.set<google::cloud::pubsublite::TopicStatsServiceRetryPolicyOption>(
      google::cloud::pubsublite::TopicStatsServiceLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::pubsublite::TopicStatsServiceRetryPolicyOption>(
  //       google::cloud::pubsublite::TopicStatsServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
