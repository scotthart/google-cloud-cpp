...
// clang-format off
// main-dox-marker: apphub_v1::AppHubClient
// lro-marker: true
// clang-format on
namespace {
...
class CustomIdempotencyPolicy
 ...
 public:
  ...
  std::unique_ptr<google::cloud::apphub_v1::AppHubConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::apphub_v1::AppHubConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::apphub_v1::AppHubRetryPolicyOption>(
      google::cloud::apphub_v1::AppHubLimitedErrorCountRetryPolicy(3).clone())
  ...
  auto c3 = google::cloud::apphub_v1::AppHubClient(
    connection, google::cloud::Options{}.set<google::cloud::apphub_v1::AppHubRetryPolicyOption>(
      google::cloud::apphub_v1::AppHubLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::apphub_v1::AppHubPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::apphub_v1::AppHubRetryPolicyOption::Type,
            google::cloud::apphub_v1::AppHubBackoffPolicyOption::Type>(
