...
// clang-format off
// main-dox-marker: networkmanagement_v1::ReachabilityServiceClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::networkmanagement_v1::ReachabilityServiceClient(
      google::cloud::networkmanagement_v1::MakeReachabilityServiceConnection(options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::networkmanagement_v1::ReachabilityServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::networkmanagement_v1::ReachabilityServiceConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::networkmanagement_v1::ReachabilityServiceConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::networkmanagement_v1::ReachabilityServiceRetryPolicyOption>(
      google::cloud::networkmanagement_v1::ReachabilityServiceLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::networkmanagement_v1::ReachabilityServiceBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::networkmanagement_v1::MakeReachabilityServiceConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::networkmanagement_v1::ReachabilityServiceClient(connection);
  auto c2 = google::cloud::networkmanagement_v1::ReachabilityServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::networkmanagement_v1::ReachabilityServiceClient(
    connection, google::cloud::Options{}.set<google::cloud::networkmanagement_v1::ReachabilityServiceRetryPolicyOption>(
      google::cloud::networkmanagement_v1::ReachabilityServiceLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::networkmanagement_v1::ReachabilityServiceRetryPolicyOption>(
  //       google::cloud::networkmanagement_v1::ReachabilityServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::networkmanagement_v1::ReachabilityServicePollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::networkmanagement_v1::ReachabilityServiceRetryPolicyOption::Type,
            google::cloud::networkmanagement_v1::ReachabilityServiceBackoffPolicyOption::Type>(
            google::cloud::networkmanagement_v1::ReachabilityServiceLimitedTimeRetryPolicy(
