...
// clang-format off
// main-dox-marker: policysimulator_v1::SimulatorClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::policysimulator_v1::SimulatorClient(
      google::cloud::policysimulator_v1::MakeSimulatorConnection(options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::policysimulator_v1::SimulatorConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::policysimulator_v1::SimulatorConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::policysimulator_v1::SimulatorConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::policysimulator_v1::SimulatorRetryPolicyOption>(
      google::cloud::policysimulator_v1::SimulatorLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::policysimulator_v1::SimulatorBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::policysimulator_v1::MakeSimulatorConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::policysimulator_v1::SimulatorClient(connection);
  auto c2 = google::cloud::policysimulator_v1::SimulatorClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::policysimulator_v1::SimulatorClient(
    connection, google::cloud::Options{}.set<google::cloud::policysimulator_v1::SimulatorRetryPolicyOption>(
      google::cloud::policysimulator_v1::SimulatorLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::policysimulator_v1::SimulatorRetryPolicyOption>(
  //       google::cloud::policysimulator_v1::SimulatorLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::policysimulator_v1::SimulatorPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::policysimulator_v1::SimulatorRetryPolicyOption::Type,
            google::cloud::policysimulator_v1::SimulatorBackoffPolicyOption::Type>(
            google::cloud::policysimulator_v1::SimulatorLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::policysimulator_v1::SimulatorClient(
      google::cloud::policysimulator_v1::MakeSimulatorConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
