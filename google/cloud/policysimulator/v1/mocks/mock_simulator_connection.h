...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_POLICYSIMULATOR_V1_MOCKS_MOCK_SIMULATOR_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_POLICYSIMULATOR_V1_MOCKS_MOCK_SIMULATOR_CONNECTION_H
...
namespace google {
namespace cloud {
namespace policysimulator_v1_mocks {
 ...
 * including errors, from an object of type `SimulatorClient`. To do so,
 * construct an object of type `SimulatorClient` with an instance of this
 ...
 */
class MockSimulatorConnection : public policysimulator_v1::SimulatorConnection {
 public:
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_POLICYSIMULATOR_V1_MOCKS_MOCK_SIMULATOR_CONNECTION_H
