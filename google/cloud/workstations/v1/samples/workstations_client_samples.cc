...
// clang-format off
// main-dox-marker: workstations_v1::WorkstationsClient
// lro-marker: true
// clang-format on
namespace {
...
void SetClientEndpoint(std::vector<std::string> const& argv) {
  ...
  auto client = google::cloud::workstations_v1::WorkstationsClient(
      google::cloud::workstations_v1::MakeWorkstationsConnection(options));
  //! [set-client-endpoint]
}

//! [custom-idempotency-policy]
class CustomIdempotencyPolicy
   : public google::cloud::workstations_v1::WorkstationsConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::workstations_v1::WorkstationsConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::workstations_v1::WorkstationsConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::workstations_v1::WorkstationsRetryPolicyOption>(
      google::cloud::workstations_v1::WorkstationsLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::workstations_v1::WorkstationsBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::workstations_v1::MakeWorkstationsConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::workstations_v1::WorkstationsClient(connection);
  auto c2 = google::cloud::workstations_v1::WorkstationsClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::workstations_v1::WorkstationsClient(
    connection, google::cloud::Options{}.set<google::cloud::workstations_v1::WorkstationsRetryPolicyOption>(
      google::cloud::workstations_v1::WorkstationsLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::workstations_v1::WorkstationsRetryPolicyOption>(
  //       google::cloud::workstations_v1::WorkstationsLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::workstations_v1::WorkstationsPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::workstations_v1::WorkstationsRetryPolicyOption::Type,
            google::cloud::workstations_v1::WorkstationsBackoffPolicyOption::Type>(
            google::cloud::workstations_v1::WorkstationsLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::workstations_v1::WorkstationsClient(
      google::cloud::workstations_v1::MakeWorkstationsConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
