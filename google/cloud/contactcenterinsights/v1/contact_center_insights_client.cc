...
StatusOr<google::longrunning::Operation>
ContactCenterInsightsClient::IngestConversations(google::cloud::ExperimentalTag,
...
StatusOr<google::longrunning::Operation>
ContactCenterInsightsClient::ExportInsightsData(google::cloud::ExperimentalTag,
                                                google::cloud::NoAwaitTag,
                                                std::string const& parent,
                                                Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
...
StatusOr<google::longrunning::Operation>
ContactCenterInsightsClient::DeleteIssueModel(google::cloud::ExperimentalTag,
                                              google::cloud::NoAwaitTag,
...
StatusOr<google::longrunning::Operation>
ContactCenterInsightsClient::DeployIssueModel(google::cloud::ExperimentalTag,
                                              google::cloud::NoAwaitTag,
                                              std::string const& name,
                                              Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
...
StatusOr<google::longrunning::Operation>
ContactCenterInsightsClient::UndeployIssueModel(google::cloud::ExperimentalTag,
                                                google::cloud::NoAwaitTag,
                                                std::string const& name,
                                                Options opts) {
  internal::OptionsSpan span(internal::MergeOptions(std::move(opts), options_));
