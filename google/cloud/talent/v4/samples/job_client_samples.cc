...
class CustomIdempotencyPolicy
 ...
 public:
  ...
  std::unique_ptr<google::cloud::talent_v4::JobServiceConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::talent_v4::JobServiceConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::talent_v4::JobServiceRetryPolicyOption>(
      google::cloud::talent_v4::JobServiceLimitedErrorCountRetryPolicy(3).clone())
  ...
  auto c3 = google::cloud::talent_v4::JobServiceClient(
    connection, google::cloud::Options{}.set<google::cloud::talent_v4::JobServiceRetryPolicyOption>(
      google::cloud::talent_v4::JobServiceLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::talent_v4::JobServicePollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::talent_v4::JobServiceRetryPolicyOption::Type,
            google::cloud::talent_v4::JobServiceBackoffPolicyOption::Type>(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::talent_v4::JobServiceClient(
      google::cloud::talent_v4::MakeJobServiceConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
