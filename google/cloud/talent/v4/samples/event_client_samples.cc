...
// clang-format off
// main-dox-marker: talent_v4::EventServiceClient
// clang-format on
namespace {
...
class CustomIdempotencyPolicy
 ...
 public:
  ...
  std::unique_ptr<google::cloud::talent_v4::EventServiceConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::talent_v4::EventServiceConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::talent_v4::EventServiceRetryPolicyOption>(
      google::cloud::talent_v4::EventServiceLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::talent_v4::EventServiceBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::talent_v4::MakeEventServiceConnection(options);
  ...
  auto c3 = google::cloud::talent_v4::EventServiceClient(
    connection, google::cloud::Options{}.set<google::cloud::talent_v4::EventServiceRetryPolicyOption>(
      google::cloud::talent_v4::EventServiceLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::talent_v4::EventServiceClient(
      google::cloud::talent_v4::MakeEventServiceConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
