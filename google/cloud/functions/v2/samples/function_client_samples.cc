...
class CustomIdempotencyPolicy
   : public google::cloud::functions_v2::FunctionServiceConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::functions_v2::FunctionServiceConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::functions_v2::FunctionServiceConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::functions_v2::FunctionServiceRetryPolicyOption>(
      google::cloud::functions_v2::FunctionServiceLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::functions_v2::FunctionServiceBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::functions_v2::MakeFunctionServiceConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::functions_v2::FunctionServiceClient(connection);
  auto c2 = google::cloud::functions_v2::FunctionServiceClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::functions_v2::FunctionServiceClient(
    connection, google::cloud::Options{}.set<google::cloud::functions_v2::FunctionServiceRetryPolicyOption>(
      google::cloud::functions_v2::FunctionServiceLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::functions_v2::FunctionServiceRetryPolicyOption>(
  //       google::cloud::functions_v2::FunctionServiceLimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
...
void SetPollingPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::functions_v2::FunctionServicePollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::functions_v2::FunctionServiceRetryPolicyOption::Type,
            google::cloud::functions_v2::FunctionServiceBackoffPolicyOption::Type>(
            google::cloud::functions_v2::FunctionServiceLimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::functions_v2::FunctionServiceClient(
      google::cloud::functions_v2::MakeFunctionServiceConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
