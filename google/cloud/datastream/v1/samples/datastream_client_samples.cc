...
// clang-format off
// main-dox-marker: datastream_v1::DatastreamClient
// lro-marker: true
// clang-format on
namespace {
...
class CustomIdempotencyPolicy
   : public google::cloud::datastream_v1::DatastreamConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::datastream_v1::DatastreamConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::datastream_v1::DatastreamConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::datastream_v1::DatastreamRetryPolicyOption>(
      google::cloud::datastream_v1::DatastreamLimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::datastream_v1::DatastreamBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::datastream_v1::MakeDatastreamConnection(options);
  ...
  auto c3 = google::cloud::datastream_v1::DatastreamClient(
    connection, google::cloud::Options{}.set<google::cloud::datastream_v1::DatastreamRetryPolicyOption>(
      google::cloud::datastream_v1::DatastreamLimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::datastream_v1::DatastreamPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::datastream_v1::DatastreamRetryPolicyOption::Type,
            google::cloud::datastream_v1::DatastreamBackoffPolicyOption::Type>(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::datastream_v1::DatastreamClient(
      google::cloud::datastream_v1::MakeDatastreamConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
