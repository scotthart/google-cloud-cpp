...
// clang-format off
// main-dox-marker: gkebackup_v1::BackupForGKEClient
// lro-marker: true
// clang-format on
namespace {
...
class CustomIdempotencyPolicy
   : public google::cloud::gkebackup_v1::BackupForGKEConnectionIdempotencyPolicy {
 public:
  ~CustomIdempotencyPolicy() override = default;
  std::unique_ptr<google::cloud::gkebackup_v1::BackupForGKEConnectionIdempotencyPolicy> clone() const override {
...
void SetRetryPolicy(std::vector<std::string> const& argv) {
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::gkebackup_v1::BackupForGKEConnectionIdempotencyPolicyOption>(
      CustomIdempotencyPolicy().clone())
    .set<google::cloud::gkebackup_v1::BackupForGKERetryPolicyOption>(
      google::cloud::gkebackup_v1::BackupForGKELimitedErrorCountRetryPolicy(3).clone())
    .set<google::cloud::gkebackup_v1::BackupForGKEBackoffPolicyOption>(
      google::cloud::ExponentialBackoffPolicy(
          /*initial_delay=*/std::chrono::milliseconds(200),
          /*maximum_delay=*/std::chrono::seconds(45),
          /*scaling=*/2.0).clone());
  auto connection = google::cloud::gkebackup_v1::MakeBackupForGKEConnection(options);

  // c1 and c2 share the same retry policies
  auto c1 = google::cloud::gkebackup_v1::BackupForGKEClient(connection);
  auto c2 = google::cloud::gkebackup_v1::BackupForGKEClient(connection);

  // You can override any of the policies in a new client. This new client
  // will share the policies from c1 (or c2) *except* for the retry policy.
  auto c3 = google::cloud::gkebackup_v1::BackupForGKEClient(
    connection, google::cloud::Options{}.set<google::cloud::gkebackup_v1::BackupForGKERetryPolicyOption>(
      google::cloud::gkebackup_v1::BackupForGKELimitedTimeRetryPolicy(std::chrono::minutes(5)).clone()));

  // You can also override the policies in a single call:
  // c3.SomeRpc(..., google::cloud::Options{}
  //     .set<google::cloud::gkebackup_v1::BackupForGKERetryPolicyOption>(
  //       google::cloud::gkebackup_v1::BackupForGKELimitedErrorCountRetryPolicy(10).clone()));
  //! [set-retry-policy]
}
  ...
  auto options = google::cloud::Options{}
    .set<google::cloud::gkebackup_v1::BackupForGKEPollingPolicyOption>(
        google::cloud::GenericPollingPolicy<
            google::cloud::gkebackup_v1::BackupForGKERetryPolicyOption::Type,
            google::cloud::gkebackup_v1::BackupForGKEBackoffPolicyOption::Type>(
            google::cloud::gkebackup_v1::BackupForGKELimitedTimeRetryPolicy(
...
void WithServiceAccount(std::vector<std::string> const& argv) {
  ...
  [](std::string const& keyfile) {
    ...
    return google::cloud::gkebackup_v1::BackupForGKEClient(
      google::cloud::gkebackup_v1::MakeBackupForGKEConnection(options));
  }
  //! [with-service-account]
  (argv.at(0));
