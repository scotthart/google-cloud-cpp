...
macro (google_cloud_cpp_enable_deps)
    ...
    if (compute_features)
        list(APPEND GOOGLE_CLOUD_CPP_ENABLE compute)
        message(
            WARNING
                "It is not possible to enable individual `compute_*`"
                " features. Simply pass `compute` to your enable list instead of:"
                " `${compute_features}`.")
    endif ()
